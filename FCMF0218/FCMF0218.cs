...
namespace FCMF0218
{
    public partial class FCMF0218 : Office2007Form
    {
        ...
        string mSave_Auto_Approval_YN = "N";    
        bool mSUB_SHOW_FLAG = false;
        string mBY_GL_DATE_FLAG = "";
        ...
        public FCMF0218(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        public FCMF0218(Form pMainForm, ISAppInterface pAppInterface, object pGL_Date_FR, object pGL_Date_TO, object pSlip_Num)
        {
            InitializeComponent();
            this.MdiParent = pMainForm;
            isAppInterfaceAdv1.AppInterface = pAppInterface;
        ...
        public FCMF0218(Form pMainForm, ISAppInterface pAppInterface, object pGL_Date_FR, object pGL_Date_TO,
        ...
        private void GetAccountBook()
        {
            ...
            //적요 복사 여부//
            IDC_SLIP_REMARK_COPY_P.SetCommandParamValue("W_ASSEMBLY_ID", "FCMF0218");
            ...
            if (mAPPROVAL_YN == "N")
            {
                V_CB_ALL.Visible = false;
                BTN_INQUIRY_APPR_PERSON_LIST.Visible = false;
                BTN_APPR_STEP.Visible = false;
                BTN_APPR_STEP_L.Visible = false;
            }
        ...
        private bool Confirm_Status(object pSELECT_CHECK_YN, object pHEADER_INTERFACE_ID, object pGL_DATE, object pCONFIRM_YN, object pREMARK)
        {
            if (iString.ISNull(pHEADER_INTERFACE_ID) == string.Empty)
            {
            ...
            object vSLIP_NUM = igrSLIP_LIST.GetCellValue("SLIP_NUM");
            string vSTATUS = "F";
            string vMESSAGE = null;
            IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("W_SELECT_CHECK_YN", pSELECT_CHECK_YN);
            IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("W_HEADER_INTERFACE_ID", pHEADER_INTERFACE_ID);
            IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_GL_DATE", pGL_DATE);
            IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_CONFIRM_YN", pCONFIRM_YN);
            IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_REMARK", pREMARK);
            IDC_UPDATE_CONFIRM_STATUS.ExecuteNonQuery();
            //C_GL_NUM.EditValue = IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_GL_NUM");
            //C_CONFIRM_USER_NAME.EditValue = IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_CONFIRM_PERSON_NAME");
            //C_CONFIRM_YN.CheckBoxValue = "Y";
            vSTATUS = iString.ISNull(IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_STATUS"));
            vMESSAGE = iString.ISNull(IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_MESSAGE"));
            if (IDC_UPDATE_CONFIRM_STATUS.ExcuteError || vSTATUS == "F")
            {
        ...
        private void Get_Balance_Statement()
        {
            ...
            if (iString.ISNull(CONFIRM_YN.EditValue) == "Y")
            {
            ...
            FCMF0218_SET vFCMF0218_SET = new FCMF0218_SET(isAppInterfaceAdv1.AppInterface, mSession_ID, mCurrency_Code, "R"
                                                        , ACCOUNT_CONTROL_ID.EditValue, ACCOUNT_CODE.EditValue, ACCOUNT_DESC.EditValue
                                                        , SLIP_DATE.EditValue);
            mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0218_SET, isAppInterfaceAdv1.AppInterface);
            vRESULT = vFCMF0218_SET.ShowDialog();
            ...
            if (pShow_Flag == true)
            {
                try
                {
                    ...
                    else if (pSub_Panel == "APPR_STEP")
                    {
                        ...
                        //GroupBox 이동//
                        GB_APPR.Controls[2].MouseDown += GB_APPR_MouseDown;
                        GB_APPR.Controls[2].MouseMove += GB_APPR_MouseMove;
                        GB_APPR.Controls[2].MouseUp += GB_APPR_MouseUp;
                        GB_APPR.Controls[3].MouseDown += GB_APPR_MouseDown;
                        GB_APPR.Controls[3].MouseMove += GB_APPR_MouseMove;
                        GB_APPR.Controls[3].MouseUp += GB_APPR_MouseUp;
        ...
        private void InsertSlipLine()
        {
            ...
            GL_DATE_L.EditValue = C_GL_DATE.EditValue;
        ...
        {
            IDA_BALANCE_SLIP_INTERFACE.SetSelectParamValue("P_GL_DATE", SLIP_DATE.EditValue);
            IDA_BALANCE_SLIP_INTERFACE.SetSelectParamValue("P_SESSION_ID", mSession_ID);
            IDA_BALANCE_SLIP_INTERFACE.Fill();
            if (IDA_BALANCE_SLIP_INTERFACE.SelectRows.Count < 1)
            {
            ...
            try
            {
                for (int i = 0; i < IDA_BALANCE_SLIP_INTERFACE.SelectRows.Count; i++)
                {
                    ...
                    {
                        if (igrSLIP_LINE.GridAdvExColElement[c].DataColumn.ToString() != "HEADER_INTERFACE_ID")
                        {
                            igrSLIP_LINE.SetCellValue(i + Row_Count, c, IDA_BALANCE_SLIP_INTERFACE.OraDataTable().Rows[i][c]);
                        }
                    } 
                    Set_Slip_Line_Seq();    //LINE SEQ 채번//
        ...
        {
            if (iString.ISNull(SLIP_QUERY_STATUS.EditValue) == "QUERY")
            {
                return;
            }
        ...
        private void XLPrinting_Main(string pOutput_Type)
        {
            ...
            if (itbSLIP.SelectedTab.TabIndex == 2)
            {
                vSlip_Header_id = H_HEADER_INTERFACE_ID.EditValue;
            }
            else
            {
                vSlip_Header_id = igrSLIP_LIST.GetCellValue("HEADER_INTERFACE_ID"); 
            }

            IDC_GET_PRINT_SLIP_P.SetCommandParamValue("W_HEADER_INTERFACE_ID", vSlip_Header_id);
            IDC_GET_PRINT_SLIP_P.ExecuteNonQuery();
            string V_CONFIRM_YN = iString.ISNull(IDC_GET_PRINT_SLIP_P.GetCommandParamValue("O_CONFIRM_YN"));
            vSlip_Header_id = IDC_GET_PRINT_SLIP_P.GetCommandParamValue("O_SLIP_HEADER_ID");
            vSlip_Date = IDC_GET_PRINT_SLIP_P.GetCommandParamValue("O_SLIP_DATE");
            vSlip_Num = IDC_GET_PRINT_SLIP_P.GetCommandParamValue("O_SLIP_NUM");

            if (V_CONFIRM_YN == "Y")
            {
                AssmblyRun_Manual("FCMF0211", vSlip_Header_id, vSlip_Date, vSlip_Num);
            }
            else
            {
        ...
        private void XLPrinting_BSK(string pOutput_Type)
        {
            ...
            if ((itbSLIP.SelectedIndex == 0 && vCountRowGrid > 0) ||
                (itbSLIP.SelectedIndex == 1 && iString.ISNull(H_HEADER_INTERFACE_ID.EditValue) != string.Empty))
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0218_011.xlsx";
                    //-------------------------------------------------------------------------------------
                    ...
                    if (isOpen == true)
                    {
                        ...
                        if (itbSLIP.SelectedTab.TabIndex == 2)
                        {
                            ...
                            vConfirm_YN = C_CONFIRM_YN.CheckBoxValue;
                        }
                        else
                        {
                            vObject = igrSLIP_LIST.GetCellValue("HEADER_INTERFACE_ID");
                            vConfirm_YN = igrSLIP_LIST.GetCellValue(vRow, igrSLIP_LIST.GetColumnToIndex("CONFIRM_YN"));
                        }
                        ...
                        if (iString.ISNull(vConfirm_YN) == "Y")
                        {
                            ...
                            xlPrinting.HeaderWrite_BSK(idaPRINT_SLIP_HEADER, vSOB_DESC, vLOCAL_DATE);
                        ...
                        {
                            idaPRINT_SLIP_IF_LINE.SetSelectParamValue("W_HEADER_INTERFACE_ID", vObject);
                            idaPRINT_SLIP_IF_LINE.Fill();

                            vCountRow = idaPRINT_SLIP_IF_LINE.CurrentRows.Count;
                            if (vCountRow > 0)
                            {
                                xlPrinting.HeaderWrite_BSK(igrSLIP_LIST, vRow, vSOB_DESC, vLOCAL_DATE);
                                vPageNumber = xlPrinting.LineWrite_BSK(idaPRINT_SLIP_IF_LINE);
                            }
                        }
        ...
        private void XLPrinting(string pOutput_Type)
        {
            ...
            int vCountRowGrid = igrSLIP_LIST.RowCount;
            if ((itbSLIP.SelectedTab.TabIndex == 1 && vCountRowGrid > 0) ||
                (itbSLIP.SelectedTab.TabIndex == 2 && iString.ISNull(H_HEADER_INTERFACE_ID.EditValue) != string.Empty))
            {
                vMessageText = string.Format("Printing Starting", vPageTotal);
                isAppInterfaceAdv1.OnAppMessage(vMessageText);
                System.Windows.Forms.Application.DoEvents();
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0218_002.xlsx";
                    //-------------------------------------------------------------------------------------
                    ...
                    if (isOpen == true)
                    {
                        ...
                        if (iString.ISNull(vConfirm_YN) == "Y")
                        {
                            ...
                            idaPRINT_SLIP_HEADER.SetSelectParamValue("W_SLIP_HEADER_INTERFACE_ID", vObject);
                            idaPRINT_SLIP_HEADER.Fill();
                            xlPrinting.HeaderWrite(idaPRINT_SLIP_HEADER, vLOCAL_DATE);
                        ...
                        else
                        {
                            ...
                            if (vCountRow > 0)
                            {
                                ...
                                vPageNumber = xlPrinting.LineWrite(idaPRINT_SLIP_IF_LINE);
                            }
                        }
                        if (pOutput_Type == "PRINT")
                        {//[PRINT]
            ...
            if (this.IsActive)
            {
                ...
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Delete)
                {
                    ...
                    {                        
                        ...
                        IDC_DELETE_SLIP.SetCommandParamValue("W_WITH_TEMP_SLIP", V2_WITH_TEMP_SLIP.CheckBoxString);
        ...
        private void FCMF0218_Load(object sender, EventArgs e)
        {
            SLIP_QUERY_STATUS.EditValue = "NON-QUERY";
            ...
            V1_WITH_TEMP_SLIP.BringToFront(); 
        }

        private void FCMF0218_Shown(object sender, EventArgs e)
        {    
            // 전표저장시 자동 승인 여부
            IDC_SAVE_AUTO_APPROVAL_YN.ExecuteNonQuery();
            mSave_Auto_Approval_YN = iString.ISNull(IDC_SAVE_AUTO_APPROVAL_YN.GetCommandParamValue("O_APPROVAL_YN"));

            IDC_GET_BY_GL_DATE_FLAG_P.ExecuteNonQuery();
            mBY_GL_DATE_FLAG = iString.ISNull(IDC_GET_BY_GL_DATE_FLAG_P.GetCommandParamValue("O_BY_GL_DATE_FLAG"));
            ...
            if (e.ColIndex == igrSLIP_LIST.GetColumnToIndex("SELECT_CHECK_YN"))
            {
                ...
                if (iString.ISNull(e.NewValue, "N") == "Y".ToString())
                {
                    if (iString.ISNull(vCONFIRM_YN) != "Y")
                    {
                        ...
                        IDC_GET_GL_DATE_P.SetCommandParamValue("W_SLIP_DATE", igrSLIP_LIST.GetCellValue("SLIP_DATE"));
                        IDC_GET_GL_DATE_P.ExecuteNonQuery();
                        igrSLIP_LIST.SetCellValue("GL_DATE", IDC_GET_GL_DATE_P.GetCommandParamValue("O_GL_DATE"));                                            
                    }
                }
                else
                {
        ...
        private void ibtSUB_FORM_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            {//받을어음
                ...
                FCMF0218_BILL vFCMF0218_BILL = new FCMF0218_BILL(isAppInterfaceAdv1.AppInterface, mDEPT_ID, mDEPT_NAME
                ...
                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0218_BILL, isAppInterfaceAdv1.AppInterface);
                dlgResult = vFCMF0218_BILL.ShowDialog();
                if (dlgResult == DialogResult.OK)
                {
                    //어음금액
                    GL_AMOUNT.EditValue = vFCMF0218_BILL.Get_BILL_AMOUNT;
                    //거래처.
                    Set_Management_Value("CUSTOMER", vFCMF0218_BILL.Get_VENDOR_CODE, vFCMF0218_BILL.Get_VENDOR_NAME);
                    //은행
                    Set_Management_Value("BANK", vFCMF0218_BILL.Get_BANK_CODE, vFCMF0218_BILL.Get_BANK_NAME);
                    //세금계산서발행일
                    Set_Management_Value("VAT_ISSUE_DATE", vFCMF0218_BILL.Get_VAT_ISSUE_DATE, null);
                    //발행일자
                    Set_Management_Value("ISSUE_DATE", vFCMF0218_BILL.Get_ISSUE_DATE, null);
                    //만기일자
                    Set_Management_Value("DUE_DATE", vFCMF0218_BILL.Get_DUE_DATE, null);
                    //만기일자
                    Set_Management_Value("TR_EXPIRATION_DATE", vFCMF0218_BILL.Get_DUE_DATE, null);  
                    //어음번호.
                    Set_Management_Value("RECEIVABLE_BILL", vFCMF0218_BILL.Get_BILL_NUM, String.Format("{0:###,###,###,###,###,###}", vFCMF0218_BILL.Get_BILL_AMOUNT));

                    Init_DR_CR_Amount();    // 차대금액 생성 //
                    Init_Total_GL_Amount(); // 총합계 및 분개 차액 생성 //
                }
                vFCMF0218_BILL.Dispose();
            }
            ...
            {//지급어음
                ...
                if (dlgResult == DialogResult.OK)
                {
                    ...
                    Set_Management_Value("TR_EXPIRATION_DATE", vFCMF0218_BILL.Get_DUE_DATE, null);  
                    //어음번호.
                    Set_Management_Value("PAYABLE_BILL", vFCMF0218_BILL.Get_BILL_NUM, String.Format("{0:###,###,###,###,###,###}", vFCMF0218_BILL.Get_BILL_AMOUNT));
            ...
            {//외화획득용 구매(공급) 확인서
                ...
                FCMF0218_ITEM_DEAL vFCMF0218_ITEM_DEAL = new FCMF0218_ITEM_DEAL(isAppInterfaceAdv1.AppInterface, mISSUE_NUM, mCURRENCY_CODE
                                                                                , mVENDOR_CODE, mBANK_CODE, mISSUE_DATE);

                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0218_ITEM_DEAL, isAppInterfaceAdv1.AppInterface);
                dlgResult = vFCMF0218_ITEM_DEAL.ShowDialog();
                if (dlgResult == DialogResult.OK)
                {
                    //거래처.4
                    Set_Management_Value("CUSTOMER", vFCMF0218_ITEM_DEAL.Get_VENDOR_CODE, vFCMF0218_ITEM_DEAL.Get_VENDOR_NAME);

                    //구매(공급)확인번호
                    Set_Management_Value("PC_ISSUE_NO", vFCMF0218_ITEM_DEAL.Get_ISSUE_NUM, DBNull.Value);

                    Set_Management_Value("BANK", vFCMF0218_ITEM_DEAL.Get_BANK_CODE, vFCMF0218_ITEM_DEAL.Get_BANK_NAME);

                    Set_Management_Value("ISSUE_DATE", vFCMF0218_ITEM_DEAL.Get_ISSUE_DATE, DBNull.Value);
                }
                vFCMF0218_ITEM_DEAL.Dispose();
            }
            Application.UseWaitCursor = false;
            System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default;
            Application.DoEvents();
        ...
        private void C_BTN_EXEC_APPROVAL_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            Confirm_Status("Y", H_HEADER_INTERFACE_ID.EditValue, C_GL_DATE.EditValue, "Y", V_APPROVAL_DESCRIPTION.EditValue); 
        ...
        private void C_BTN_EXEC_RETURN_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            //}
            //else 
            if (iString.ISNull(vCONFIRM_YN) == "R")
            {//반려 처리됨.
                Application.UseWaitCursor = false;
                System.Windows.Forms.Cursor.Current = Cursors.WaitCursor;
                Application.DoEvents();
            ...
            Confirm_Status("Y", H_HEADER_INTERFACE_ID.EditValue, C_GL_DATE.EditValue, "R", V_RETURN_REMARK.EditValue);  //반려  
        ...
        private void btnCONFIRM_CANCEL_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            idcSLIP_CONFIRM_YN.ExecuteNonQuery();
            object vCONFIRM_YN = idcSLIP_CONFIRM_YN.GetCommandParamValue("O_CONFIRM_YN");
            if (iString.ISNull(vCONFIRM_YN) == "N")
            {//미승인상태 -> 취소 데이터 없음
                MessageBoxAdv.Show(isMessageAdapter1.ReturnText("EAPP_10137"), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            Confirm_Status("Y", H_HEADER_INTERFACE_ID.EditValue, C_GL_DATE.EditValue, "N", string.Empty);  //승인취소 

            Search_DB_DETAIL(H_HEADER_INTERFACE_ID.EditValue);
        }

        private void btnSUBSTANCE_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            FCMF0218_SUBSTANCE vFCMF0218_SUBSTANCE = new FCMF0218_SUBSTANCE(isAppInterfaceAdv1.AppInterface, H_HEADER_INTERFACE_ID.EditValue);
            mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0218_SUBSTANCE, isAppInterfaceAdv1.AppInterface);
            vdlgResult =  vFCMF0218_SUBSTANCE.ShowDialog();
            vFCMF0218_SUBSTANCE.Dispose();
        }
        ...
        private void btnSELECT_ALL_0_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            int vIDX_CHECK_YN = igrSLIP_LIST.GetColumnToIndex("SELECT_CHECK_YN");
            int vIDX_GL_DATE = igrSLIP_LIST.GetColumnToIndex("GL_DATE");
            int vIDX_SLIP_DATE = igrSLIP_LIST.GetColumnToIndex("SLIP_DATE");
            
            for (int i = 0; i < igrSLIP_LIST.RowCount; i++)
            {
                igrSLIP_LIST.CurrentCellMoveTo(i, vIDX_CHECK_YN);
                igrSLIP_LIST.CurrentCellActivate(i, vIDX_CHECK_YN);

                if (iString.ISNull(igrSLIP_LIST.GetCellValue(i, vIDX_CHECK_YN), "N") == "Y".ToString())
                {
                    igrSLIP_LIST.SetCellValue(i, vIDX_CHECK_YN, "N");
                    igrSLIP_LIST.SetCellValue(i, vIDX_GL_DATE, null);
                }
                else
                {
                    igrSLIP_LIST.SetCellValue(i, vIDX_CHECK_YN, "Y");                    
                    if (vCONFIRM_YN == "N")
                    {
                        if (mBY_GL_DATE_FLAG == "CURRENT")
                        {
                        ...
                        IDC_GET_GL_DATE_P.SetCommandParamValue("W_SLIP_DATE", igrSLIP_LIST.GetCellValue(i, vIDX_SLIP_DATE));
                        IDC_GET_GL_DATE_P.ExecuteNonQuery();
                        igrSLIP_LIST.SetCellValue(i, vIDX_GL_DATE, IDC_GET_GL_DATE_P.GetCommandParamValue("O_GL_DATE")); 
                    }
                    else
                    {
        ...
        private void btnCONFIRM_YES_0_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            System.Windows.Forms.Cursor.Current = Cursors.WaitCursor;
            Application.DoEvents();
            int vIDX_HEADER_INTERFACE_ID = igrSLIP_LIST.GetColumnToIndex("HEADER_INTERFACE_ID");
            int vIDX_GL_DATE = igrSLIP_LIST.GetColumnToIndex("GL_DATE");
            ...
            int vIDX_CONFIRM_YN = igrSLIP_LIST.GetColumnToIndex("CONFIRM_YN");
            ...
            for (int i = 0; i < igrSLIP_LIST.RowCount; i++)
            {
                ...
                {
                    if (iString.ISNull(igrSLIP_LIST.GetCellValue(i, vIDX_HEADER_INTERFACE_ID)) == string.Empty)
                    {
                        Application.UseWaitCursor = false;
                        System.Windows.Forms.Cursor.Current = Cursors.WaitCursor;
                        Application.DoEvents();
                        ...
                        MessageBoxAdv.Show(isMessageAdapter1.ReturnText("FCM_10128"), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        igrSLIP_LIST.CurrentCellMoveTo(i, vIDX_HEADER_INTERFACE_ID);
                        igrSLIP_LIST.CurrentCellActivate(i, vIDX_HEADER_INTERFACE_ID);
                        igrSLIP_LIST.Focus();
                        return;
                    }

                    if (iString.ISNull(igrSLIP_LIST.GetCellValue(i, vIDX_GL_DATE)) == string.Empty)
                    {
                        Application.UseWaitCursor = false;
                        System.Windows.Forms.Cursor.Current = Cursors.Default;
                        Application.DoEvents();
                        ...
                        MessageBoxAdv.Show(isMessageAdapter1.ReturnText("FCM_10187"), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        igrSLIP_LIST.CurrentCellMoveTo(i, vIDX_GL_DATE);
                        igrSLIP_LIST.CurrentCellActivate(i, vIDX_GL_DATE);
                        igrSLIP_LIST.Focus();
                        return;
                    }

                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("W_SELECT_CHECK_YN", "Y");
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("W_HEADER_INTERFACE_ID", igrSLIP_LIST.GetCellValue(i, vIDX_HEADER_INTERFACE_ID));
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_GL_DATE", igrSLIP_LIST.GetCellValue(i, vIDX_GL_DATE));
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_CONFIRM_YN", "Y");
                    IDC_UPDATE_CONFIRM_STATUS.ExecuteNonQuery();
                    igrSLIP_LIST.SetCellValue(i, vIDX_GL_NUM, IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_GL_NUM"));
                    igrSLIP_LIST.SetCellValue(i, vIDX_CONFIRM_PERSON_NAME, IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_CONFIRM_PERSON_NAME"));
                    vSTATUS = iString.ISNull(IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_STATUS"));
                    vMESSAGE = iString.ISNull(IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_MESSAGE"));
                    if (IDC_UPDATE_CONFIRM_STATUS.ExcuteError || vSTATUS == "F")
                    {
                    ...
                    igrSLIP_LIST.SetCellValue(i, vIDX_CONFIRM_YN, "Y");
                }
            }
            igrSLIP_LIST.LastConfirmChanges();
            idaSLIP_HEADER_IF_LIST.OraSelectData.AcceptChanges();
        ...
        private void BTN_RETURN_0_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            Application.UseWaitCursor = true;
            System.Windows.Forms.Cursor.Current = Cursors.WaitCursor;
            Application.DoEvents();
            ...
            for (int i = 0; i < igrSLIP_LIST.RowCount; i++)
            {
                if (iString.ISNull(igrSLIP_LIST.GetCellValue(i, igrSLIP_LIST.GetColumnToIndex("SELECT_CHECK_YN")), "N") == "Y".ToString())
                {
                    ...
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("W_SELECT_CHECK_YN", "Y");
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("W_HEADER_INTERFACE_ID", igrSLIP_LIST.GetCellValue(i, vIDX_HEADER_INTERFACE_ID));
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_GL_DATE", DBNull.Value);
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_CONFIRM_YN", "R");
                    IDC_UPDATE_CONFIRM_STATUS.ExecuteNonQuery();
        ...
        private void btnCONFIRM_CANCEL_0_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            for (int i = 0; i < igrSLIP_LIST.RowCount; i++)
            {
                if (iString.ISNull(igrSLIP_LIST.GetCellValue(i, igrSLIP_LIST.GetColumnToIndex("SELECT_CHECK_YN")), "N") == "Y".ToString())
                {
                    ...
                    if (iString.ISNull(igrSLIP_LIST.GetCellValue(i, vIDX_CONFIRM_YN)) == "R")
                    {
                        //
                    }
                    else if (iString.ISNull(igrSLIP_LIST.GetCellValue(i, vIDX_GL_DATE)) == string.Empty)
                    {
                        Application.UseWaitCursor = false;
                        System.Windows.Forms.Cursor.Current = Cursors.Default;
                        Application.DoEvents();
                    ...
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("W_HEADER_INTERFACE_ID", igrSLIP_LIST.GetCellValue(i, vIDX_HEADER_INTERFACE_ID));
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_GL_DATE", igrSLIP_LIST.GetCellValue(i, vIDX_GL_DATE));
                    IDC_UPDATE_CONFIRM_STATUS.SetCommandParamValue("P_CONFIRM_YN", "N");
                    IDC_UPDATE_CONFIRM_STATUS.ExecuteNonQuery();
                    igrSLIP_LIST.SetCellValue(i, vIDX_GL_NUM, IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_GL_NUM"));
                    igrSLIP_LIST.SetCellValue(i, vIDX_CONFIRM_PERSON_NAME, IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_CONFIRM_PERSON_NAME"));
                    vSTATUS = iString.ISNull(IDC_UPDATE_CONFIRM_STATUS.GetCommandParamValue("O_STATUS"));
                    ...
                    igrSLIP_LIST.SetCellValue(i, vIDX_CONFIRM_YN, "N");
                }
            }
            igrSLIP_LIST.LastConfirmChanges();
            idaSLIP_HEADER_IF_LIST.OraSelectData.AcceptChanges();
        ...
        private void irbCONFIRM_Status_CheckChanged(object sender, EventArgs e)
        {
            ...
            {
                btnSELECT_ALL_0.Enabled = true;
                btnCONFIRM_YES_0.Enabled = true;
                btnCONFIRM_CANCEL_0.Enabled = false;
                BTN_RETURN_0.Enabled = true;
            ...
            {
                btnSELECT_ALL_0.Enabled = true;
                btnCONFIRM_YES_0.Enabled = false;
                btnCONFIRM_CANCEL_0.Enabled = true;
                BTN_RETURN_0.Enabled = false;
        ...
        private void GL_DATE_L_EditValueChanged(object pSender) 
        {
            if (iString.ISNull(GL_DATE_L.EditValue) != string.Empty)
            {
                C_GL_DATE.EditValue = GL_DATE_L.EditValue;
            }
        }
        ...
        private void idaSLIP_HEADER_IF_LIST_PreNewRowMoved(object pSender, ISBindingEventArgs pBindingManager)
        {
            ...
            else if (vCONFIRM_YN == string.Empty)
            {
                Set_Grid_Select(igrSLIP_LIST, "0");
                Set_Grid_Status(igrSLIP_LIST, "0");
            }
        ...
        private void idaSLIP_LINE_PreRowUpdate(ISPreRowUpdateEventArgs e)
        {
            ...
            {
                MessageBoxAdv.Show(Get_Edit_Prompt(GL_DATE_L).ToString(), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                e.Cancel = true;
                return;
            }
        ...
        private void idaSLIP_LINE_FilterCompleted(object pSender, DataView pOraDataView, ISBindingEventArgs pBindingManager)
        {
            //if (pBindingManager.DataRow == null)
            //{
            //    return;
        ...
        private void idaSLIP_HEADER_FillCompleted(object pSender, DataView pOraDataView, ISBindingEventArgs pBindingManager)
        {
            ...
            if (iString.ISNull(pBindingManager.DataRow["SUBSTANCE_YN"]) == "Y")
            {
        ...
        private void BTN_APPR_STEP_L_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            A_SLIP_DATE.EditValue = igrSLIP_LIST.GetCellValue("SLIP_DATE");
            A_SLIP_NUM.EditValue = igrSLIP_LIST.GetCellValue("SLIP_NUM");
            V.Fill();
