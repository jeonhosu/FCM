...
namespace FCMF0241
{
    public partial class FCMF0241 : Office2007Form
    {
        ...
        private void Show_Slip_Detail()
        {
            try
            {
                int mSLIP_HEADER_ID = iConv.ISNumtoZero(igrSLIP_LINE_JOURNALIZE.GetCellValue("SLIP_HEADER_ID"));
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    ExcelExport(idaSLIP_LINE_JOURNALIZE, igrSLIP_LINE_JOURNALIZE);
                }
            }
        }
        ...
        {
            CB_SLIP_DETAIL_YN.CheckedState = ISUtil.Enum.CheckedState.Unchecked;
