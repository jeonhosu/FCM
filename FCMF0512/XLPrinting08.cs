...
namespace FCMF0512
{
    public class XLPrinting08 : XLInterface
    {
        #region ----- Variables -----
        ...
        public XLPrinting08(InfoSummit.Win.ControlAdv.ISAppInterface pAppInterface, InfoSummit.Win.ControlAdv.ISMessageAdapter pMessageAdapter)
        {
        ...
        public XLPrinting08(XL.XLPrint pPrinting, InfoSummit.Win.ControlAdv.ISAppInterface pAppInterface, InfoSummit.Win.ControlAdv.ISMessageAdapter pMessageAdapter)
        {
            mPrinting = pPrinting;
            mAppInterface = pAppInterface;
            mMessageAdapter = pMessageAdapter;
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISGridAdvEx[] pGrid, string pDate)
        {
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    mPrinting.XLActiveSheet("SourceTab8");
        ...
        private int CopyAndPaste(XL.XLPrint pPrinting, int pCopySumPrintingLine)
        {
            ...
            pPrinting.XLActiveSheet("SourceTab8");
