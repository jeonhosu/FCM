...
namespace FCMF0512
{
    public class XLPrinting06 : XLInterface
    {
        #region ----- Variables -----
        ...
        public XLPrinting06(InfoSummit.Win.ControlAdv.ISAppInterface pAppInterface, InfoSummit.Win.ControlAdv.ISMessageAdapter pMessageAdapter)
        {
        ...
        public XLPrinting06(XL.XLPrint pPrinting, InfoSummit.Win.ControlAdv.ISAppInterface pAppInterface, InfoSummit.Win.ControlAdv.ISMessageAdapter pMessageAdapter)
        {
            mPrinting = pPrinting;
            mAppInterface = pAppInterface;
            mMessageAdapter = pMessageAdapter;
        ...
        private void SetArray(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[3] = pGrid.GetColumnToIndex("LOAN_AMOUNT");           //최초차입금
            ...
            pGDColumn[10] = pGrid.GetColumnToIndex("ISSUE_DATE");           //대출일
            ...
            pXLColumn[1] = 10;   //대출과목
            pXLColumn[2] = 15;   //계좌번호
            pXLColumn[3] = 22;   //최초차입금
            pXLColumn[4] = 27;   //전일잔액
            pXLColumn[5] = 32;   //금일차입
            pXLColumn[6] = 37;   //금일상환
            pXLColumn[7] = 42;   //차입금잔액
            pXLColumn[8] = 48;   //통화
            pXLColumn[9] = 50;   //외화잔액
            pXLColumn[10] = 55;  //대출일
            pXLColumn[11] = 59;  //만기일
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISGridAdvEx[] pGrid, string pDate)
        {
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    mPrinting.XLActiveSheet("SourceTab6");
        ...
        private int CopyAndPaste(XL.XLPrint pPrinting, int pCopySumPrintingLine)
        {
            ...
            pPrinting.XLActiveSheet("SourceTab6");
