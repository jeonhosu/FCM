...
namespace FCMF0627
{
    public partial class FCMF0627 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0627(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void XLPrinting_Main(string pOutput_Type)
        {
            ...
            IDC_GET_REPORT_SET_P.SetCommandParamValue("P_ASSEMBLY_ID", "FCMF0627");
        ...
        private void XLPrinting(string pOutput_Type)
        {
            ...
            try
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0627_001.xlsx"; 
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0627_002.xlsx";
                    bool isOpen = xlPrinting.XLFileOpen();
                    //-------------------------------------------------------------------------------------
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    if (IDA_BUDGET_ADD_LINE.CurrentRow.RowState == DataRowState.Added)
                    {
        ...
        private void FCMF0627_Load(object sender, EventArgs e)
        {
        ...
        private void FCMF0627_Shown(object sender, EventArgs e)
        {
        ...
        private void BTN_CANCEL_REQ_APPROVAL_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            IDC_CANCEL_BUDGET_ADD_APPR.ExecuteNonQuery();
            string vSTATUS = iString.ISNull(IDC_CANCEL_BUDGET_ADD_APPR.GetCommandParamValue("O_STATUS"));
            string vMESSAGE = iString.ISNull(IDC_CANCEL_BUDGET_ADD_APPR.GetCommandParamValue("O_MESSAGE"));

            Application.UseWaitCursor = false;
            System.Windows.Forms.Cursor.Current = Cursors.Default;
            Application.DoEvents();

            if (IDC_CANCEL_BUDGET_ADD_APPR.ExcuteError || vSTATUS == "F")
            {
                if (vMESSAGE != string.Empty)
                {
                    MessageBoxAdv.Show(vMESSAGE, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void C_BTN_EXEC_APPROVAL_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            IDC_EXEC_BUDGET_ADD_APPR.SetCommandParamValue("P_APPROVAL_DESCRIPTION", V_APPROVAL_DESCRIPTION.EditValue);
            IDC_EXEC_BUDGET_ADD_APPR.ExecuteNonQuery();
            string vSTATUS = iString.ISNull(IDC_EXEC_BUDGET_ADD_APPR.GetCommandParamValue("O_STATUS"));
            string vMESSAGE = iString.ISNull(IDC_EXEC_BUDGET_ADD_APPR.GetCommandParamValue("O_MESSAGE"));

            Application.UseWaitCursor = false;
            System.Windows.Forms.Cursor.Current = Cursors.Default;
            Application.DoEvents();

            if (IDC_EXEC_BUDGET_ADD_APPR.ExcuteError || vSTATUS == "F")
            {
                if (vMESSAGE != string.Empty)
                {
                    MessageBoxAdv.Show(vMESSAGE, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void C_BTN_EXEC_RETURN_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            IDC_EXEC_BUDGET_ADD_RETURN.ExecuteNonQuery();
            string vSTATUS = iString.ISNull(IDC_EXEC_BUDGET_ADD_RETURN.GetCommandParamValue("O_STATUS"));
            string vMESSAGE = iString.ISNull(IDC_EXEC_BUDGET_ADD_RETURN.GetCommandParamValue("O_MESSAGE"));

            Application.UseWaitCursor = false;
            System.Windows.Forms.Cursor.Current = Cursors.Default;
            Application.DoEvents();

            if (IDC_EXEC_BUDGET_ADD_RETURN.ExcuteError || vSTATUS == "F")
            {
                if (vMESSAGE != string.Empty)
                {
                    MessageBoxAdv.Show(vMESSAGE, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void BTN_CHG_APPROVAL_STEP_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            FCMF0627_APPR_STEP vFCMF0627_APPR_STEP = new FCMF0627_APPR_STEP(isAppInterfaceAdv1.AppInterface,
            ...
            dlgResult = vFCMF0627_APPR_STEP.ShowDialog();
            Application.DoEvents();

            vFCMF0627_APPR_STEP.Dispose();
            SearchDB_DTL(BUDGET_ADD_HEADER_ID.EditValue);
        }
