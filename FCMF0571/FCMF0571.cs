...
namespace FCMF0571
{
    public partial class FCMF0571 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0571(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        {
            ILD_ACCOUNT_CONTROL_W.SetLookupParamValue("P_ACCOUNT_CLASS_CODE", "");
        ...
        private void XLPrinting1(string pOutput_Type)
        {
            ...
            if (vCountRowGrid > 0)
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0571_001.xls";
                    //-------------------------------------------------------------------------------------
