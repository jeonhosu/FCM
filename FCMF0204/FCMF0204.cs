...
namespace FCMF0204
{
    public partial class FCMF0204 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0204(Form pMainForm, ISAppInterface pAppInterface, object pSLIP_HEADER_ID)
        {
            InitializeComponent();
        ...
        public FCMF0204(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
            this.MdiParent = pMainForm;
            isAppInterfaceAdv1.AppInterface = pAppInterface;
            //mSLIP_HEADER_ID = 500009447;
        }
        ...
        private void GetAccountBook()
        {
            ...
            //적요 복사 여부//
            IDC_SLIP_REMARK_COPY_P.SetCommandParamValue("W_ASSEMBLY_ID", "FCMF0204");
        ...
        //{
        //    int mCurrent_RowIndex = igrSLIP_LINE.RowIndex;
        //    idaCONTROL_ITEM_PROMPT.Fill();
        //    if (idaCONTROL_ITEM_PROMPT.CurrentRows.Count > 0)
        //    {
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT1_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT2_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_NAME"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_NAME"]);

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT1_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT2_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_YN"]);

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT1_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT2_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_LOOKUP_YN"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_LOOKUP_YN"]);

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT1_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT2_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_LOOKUP_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_LOOKUP_TYPE"]);

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT1_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["MANAGEMENT2_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_DATA_TYPE"]);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_DATA_TYPE"]);
        //    }
        //    else
        //    {
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_NAME"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_NAME"), null);

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_YN"), "F");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_YN"), "F");

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_LOOKUP_YN"), "N");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_LOOKUP_YN"), "N");

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_LOOKUP_TYPE"), null);
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_LOOKUP_TYPE"), null);

        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_DATA_TYPE"), "VARCHAR2");
        //        igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_DATA_TYPE"), "VARCHAR2");
        //    }
        //}
        ...
        private void Get_Balance_Statement()
        {
            ...
            FCMF0204_SET vFCMF0204_SET = new FCMF0204_SET(isAppInterfaceAdv1.AppInterface, mSession_ID, mCurrency_Code, "R", 
                                                          ACCOUNT_CONTROL_ID.EditValue, ACCOUNT_CODE.EditValue, ACCOUNT_DESC.EditValue,
                                                          GL_DATE.EditValue);
            mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0204_SET, isAppInterfaceAdv1.AppInterface);
            vRESULT = vFCMF0204_SET.ShowDialog();
        ...
        private void Set_Insert_Slip_Line()
        {
            ...
            try
            {
                for (int i = 0; i < IDA_BALANCE_SLIP_LINE.SelectRows.Count; i++)
                {
                    ...
                    for (int c = 0; c < igrSLIP_LINE.GridAdvExColElement.Count; c++)
                    {
                        ...
                        {
                            igrSLIP_LINE.SetCellValue(i + Row_Count, c, IDA_BALANCE_SLIP_LINE.OraDataTable().Rows[i][c]);
                        }
                    }
                    Set_Slip_Line_Seq();    //LINE SEQ 채번//
            ...
            {
                 if (iString.ISDecimaltoZero(vRow["UNLIQUIDATE_SLIP_LINE_ID"], 0) != 0)
                {
                ...
                if (vREAD_FLAG == "Y")
                {
                    ...
                    try
                    {
                        ...
                        if (vType != null)
                        {
                            ...
                            vParam[5] = pSLIP_Date;             //작성일자
                            vParam[6] = pSLIP_Num;              //작성번호
                            vParam[7] = "Y";      //프린트 옵션 표시 여부
        ...
        private void XLPrinting_Main(string pOutput_Type)
        {
            ...
            //IDC_GET_REPORT_SET_P.SetCommandParamValue("P_ASSEMBLY_ID", "FCMF0204");
        ...
        private void XLPrinting(string pOutput_Type)
        {
            ...
            int vCountRowGrid = idaSLIP_HEADER.CurrentRows.Count;
                ...
                (itbSLIP.SelectedIndex == 1 && iString.ISNull(H_SLIP_HEADER_ID.EditValue) != string.Empty))
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0204_001.xlsx";
                    //-------------------------------------------------------------------------------------
                    ...
                    if (isOpen == true)
                    {
                        ...
                        idaPRINT_SLIP_LINE.SetSelectParamValue("W_SLIP_HEADER_ID", mSLIP_HEADER_ID);
                        idaPRINT_SLIP_LINE.Fill();

                        int vCountRow = idaPRINT_SLIP_LINE.CurrentRows.Count;
                        if (vCountRow > 0)
                        {
        ...
        private void XLPrinting_BSK(string pOutput_Type)
        {
                ...
                (itbSLIP.SelectedIndex == 1 && iString.ISNull(H_SLIP_HEADER_ID.EditValue) != string.Empty))
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0204_011.xlsx";
                    //-------------------------------------------------------------------------------------
        ...
        private void FCMF0204_Load(object sender, EventArgs e)
        {
            // 회계장부 정보 설정.
            GetAccountBook();
        ...
        private void FCMF0204_Shown(object sender, EventArgs e)
        {
            Application.UseWaitCursor = false;
            System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default;
            Application.DoEvents();
        ...
        private void btnSUB_FORM_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            {//받을어음
                ...
                FCMF0204_BILL vFCMF0204_BILL = new FCMF0204_BILL(isAppInterfaceAdv1.AppInterface, mDEPT_ID, mDEPT_NAME
                ...
                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0204_BILL, isAppInterfaceAdv1.AppInterface);
                dlgResult = vFCMF0204_BILL.ShowDialog();
                if (dlgResult == DialogResult.OK)
                {
                    //어음금액
                    GL_AMOUNT.EditValue = vFCMF0204_BILL.Get_BILL_AMOUNT;
                    //거래처.
                    Set_Management_Value("CUSTOMER", vFCMF0204_BILL.Get_VENDOR_CODE, vFCMF0204_BILL.Get_VENDOR_NAME);
                    //은행
                    Set_Management_Value("BANK", vFCMF0204_BILL.Get_BANK_CODE, vFCMF0204_BILL.Get_BANK_NAME);
                    //세금계산서발행일
                    Set_Management_Value("VAT_ISSUE_DATE", vFCMF0204_BILL.Get_VAT_ISSUE_DATE, null);
                    //발행일자
                    Set_Management_Value("ISSUE_DATE", vFCMF0204_BILL.Get_ISSUE_DATE, null);
                    //만기일자
                    Set_Management_Value("DUE_DATE", vFCMF0204_BILL.Get_DUE_DATE, null);
                    //만기일자
                    Set_Management_Value("TR_EXPIRATION_DATE", vFCMF0204_BILL.Get_DUE_DATE, null);  
                    //어음번호.
                    Set_Management_Value("RECEIVABLE_BILL", vFCMF0204_BILL.Get_BILL_NUM, String.Format("{0:###,###,###,###,###,###}", vFCMF0204_BILL.Get_BILL_AMOUNT));

                    Init_DR_CR_Amount();    // 차대금액 생성 //
                    Init_Total_GL_Amount(); // 총합계 및 분개 차액 생성 //
                }
                vFCMF0204_BILL.Dispose();
            }
            ...
            {//지급어음
                ...
                if (dlgResult == DialogResult.OK)
                {
                    ...
                    Set_Management_Value("TR_EXPIRATION_DATE", vFCMF0204_BILL.Get_DUE_DATE, null);  
                    //어음번호.
                    Set_Management_Value("PAYABLE_BILL", vFCMF0204_BILL.Get_BILL_NUM, String.Format("{0:###,###,###,###,###,###}", vFCMF0204_BILL.Get_BILL_AMOUNT));
            ...
            {//외화획득용 구매(공급) 확인서
                ...
                FCMF0204_ITEM_DEAL vFCMF0204_ITEM_DEAL = new FCMF0204_ITEM_DEAL(isAppInterfaceAdv1.AppInterface, mISSUE_NUM, mCURRENCY_CODE
                                                                                , mVENDOR_CODE, mBANK_CODE, mISSUE_DATE);

                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0204_ITEM_DEAL, isAppInterfaceAdv1.AppInterface);
                dlgResult = vFCMF0204_ITEM_DEAL.ShowDialog();
                if (dlgResult == DialogResult.OK)
                {
                    //거래처.4
                    Set_Management_Value("CUSTOMER", vFCMF0204_ITEM_DEAL.Get_VENDOR_CODE, vFCMF0204_ITEM_DEAL.Get_VENDOR_NAME);

                    //구매(공급)확인번호
                    Set_Management_Value("PC_ISSUE_NO", vFCMF0204_ITEM_DEAL.Get_ISSUE_NUM, DBNull.Value);

                    Set_Management_Value("BANK", vFCMF0204_ITEM_DEAL.Get_BANK_CODE, vFCMF0204_ITEM_DEAL.Get_BANK_NAME);

                    Set_Management_Value("ISSUE_DATE", vFCMF0204_ITEM_DEAL.Get_ISSUE_DATE, DBNull.Value);

                }
                vFCMF0204_ITEM_DEAL.Dispose();
            }            
            ...
            //    FCMF0204_UNLIQUIDATE_LIST vFCMF0204_UNLIQUIDATE_LIST = new FCMF0204_UNLIQUIDATE_LIST(isAppInterfaceAdv1.AppInterface, idaUNLIQUIDATE_LIST
            ...
            //    dlgResult = vFCMF0204_UNLIQUIDATE_LIST.ShowDialog();
            //    if (dlgResult == DialogResult.OK)
            //    {
            //        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor;
            ...
            //        int mOld_Account_Control_ID = iString.ISDecimaltoZero(igrSLIP_LINE.GetCellValue(vCURRENT_ROW_INDEX, igrSLIP_LINE.GetColumnToIndex("ACCOUNT_CONTROL_ID")), -1);
            ...
            //        for (int r = 0; r < idaUNLIQUIDATE_LIST.CurrentRows.Count; r++)
            //        {//기존 전표라인 삭제(차대구분, 계정관리ID, 통화, 고객사, 단 현재 로우는 제외.)
            //            if ("Y".ToString() == idaUNLIQUIDATE_LIST.CurrentRows[r]["CHECK_YN"].ToString()
            //                && iString.ISDecimaltoZero(idaUNLIQUIDATE_LIST.CurrentRows[r]["NEW_GL_AMOUNT"]) != Convert.ToDecimal(0))
            //            {
            ...
            //                    mNew_Account_Control_ID = iString.ISDecimaltoZero(igrSLIP_LINE.GetCellValue(sr, igrSLIP_LINE.GetColumnToIndex("ACCOUNT_CONTROL_ID")));
            ...
            //                    {// 전표에 동일한 정보 존재.                                    
            //                        igrSLIP_LINE.SetCellValue(sr, igrSLIP_LINE.GetColumnToIndex("UNLIQUIDATE_SLIP_LINE_ID"), idaUNLIQUIDATE_LIST.CurrentRows[r]["SLIP_LINE_ID"]);
            //                        igrSLIP_LINE.SetCellValue(sr, igrSLIP_LINE.GetColumnToIndex("EXCHANGE_RATE"), idaUNLIQUIDATE_LIST.CurrentRows[r]["EXCHANGE_RATE"]);
            //                        igrSLIP_LINE.SetCellValue(sr, igrSLIP_LINE.GetColumnToIndex("GL_CURRENCY_AMOUNT"), idaUNLIQUIDATE_LIST.CurrentRows[r]["NEW_CURRENCY_AMOUNT"]);
            //                        igrSLIP_LINE.SetCellValue(sr, igrSLIP_LINE.GetColumnToIndex("GL_AMOUNT"), idaUNLIQUIDATE_LIST.CurrentRows[r]["NEW_GL_AMOUNT"]);
            //                        mSlip_RowCount = sr + 1;
            ...
            //                {// 기본통화가 아닐경우 환차손익 체크.
            //                    decimal mOld_Exchange_Rate = iString.ISDecimaltoZero(idaUNLIQUIDATE_LIST.CurrentRows[r]["EXCHANGE_RATE"]);
            //                    decimal mCurrency_Amount = iString.ISDecimaltoZero(idaUNLIQUIDATE_LIST.CurrentRows[r]["NEW_CURRENCY_AMOUNT"]);
            //                    decimal mGL_Amount = iString.ISDecimaltoZero(idaUNLIQUIDATE_LIST.CurrentRows[r]["NEW_GL_AMOUNT"]);
            ...
            //                    Set_Slip_Line_Seq();    //LINE SEQ 채번//
            //                    // 반제 SLIP_LINE_ID.
            //                    EXCHANGE_RATE.EditValue = iString.ISDecimaltoZero(idaUNLIQUIDATE_LIST.CurrentRows[r]["EXCHANGE_RATE"]);
            //                    GL_CURRENCY_AMOUNT.EditValue = iString.ISDecimaltoZero(idaUNLIQUIDATE_LIST.CurrentRows[r]["NEW_CURRENCY_AMOUNT"]);
            //                    GL_AMOUNT.EditValue = iString.ISDecimaltoZero(idaUNLIQUIDATE_LIST.CurrentRows[r]["NEW_GL_AMOUNT"]);
            ...
            //                mNew_Account_Control_ID = iString.ISDecimaltoZero(igrSLIP_LINE.GetCellValue(rc - 1, igrSLIP_LINE.GetColumnToIndex("ACCOUNT_CONTROL_ID")));
            ...
            //    if (idaSLIP_LINE.CurrentRows.Count == Convert.ToInt32(0))
            //    {
            //        idaSLIP_LINE.Cancel();
            //    }
            //    idaUNLIQUIDATE_LIST.Cancel();
            //    vFCMF0204_UNLIQUIDATE_LIST.Dispose();
            //}
            Application.UseWaitCursor = false;
            System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default;
            Application.DoEvents();
        ...
        private void idaSLIP_LINE_NewRowMoved(object pSender, ISBindingEventArgs pBindingManager)
        {
            ...
            //Init_Currency_Amount();
            //GetSubForm();
            //if (iString.ISNull(mSLIP_QUERY_STATUS) != "QUERY".ToString())
            //{
            //    Init_DR_CR_Amount();
            //}
            //Init_Total_GL_Amount();
        ...
        private void idaDPR_ASSET_UpdateCompleted(object pSender)
        {
