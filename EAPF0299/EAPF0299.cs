...
namespace EAPF0299
{
    public partial class EAPF0299 : Office2007Form
    {
        ...
        private void EAPF0299_Shown(object sender, EventArgs e)
        {
            ...
            IDC_GET_ADDRESS_URL_P.ExecuteNonQuery(); 
            mConfirmKey = iConvert.ISNull(IDC_GET_ADDRESS_URL_P.GetCommandParamValue("O_CONFIRM_KEY"));
            mCountPerPage = iConvert.ISNull(IDC_GET_ADDRESS_URL_P.GetCommandParamValue("O_COUNT_PER_PAGE")); 
