...
namespace FCMF0811
{
    public class XLPrinting
    {
        ...
        private int mCopy_EndCol = 42;
        private int mCopy_EndRow = 41;
        private int mPrintingLastRow = 41;  //최종 인쇄 라인.
        ...
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            ...
            // 매입세액불공제코드.
            object mVAT_NOT_DED_CODE = pGrid.GetCellValue(pGridRow, pGrid.GetColumnToIndex("NOT_DED_CODE"));
            if (iString.ISNull(mVAT_NOT_DED_CODE) == "0")
            {
                vXLine = 19;
            }
