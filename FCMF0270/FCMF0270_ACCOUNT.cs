...
namespace FCMF0270
{
    public partial class FCMF0270_ACCOUNT : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0270_ACCOUNT()
        {
            InitializeComponent();
        }

        public FCMF0270_ACCOUNT(Form pMainForm, ISAppInterface pAppInterface, object pSALE_HEADER_ID, string pSLIP_LINE_TYPE,
        ...
        private void GetAccountBook()
        {
            ...
            if (mCURRENCY_CODE == string.Empty)
            {
                mCURRENCY_CODE = mBASE_CURRENCY_CODE;
            }
        ...
        {
            int mPreviousRowPosition = IDA_PE_CANCEL_SLIP_DTL.CurrentRowPosition() - 1;
            ...
            if (mPreviousRowPosition > -1
                ...
                && iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REMARK"]) != string.Empty)
            {//REMARK.
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REMARK"];
                REMARK.EditValue = mPrevious_Name;
            }
            
            //1
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["MANAGEMENT1_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["MANAGEMENT1_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                ...
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["MANAGEMENT1_LOOKUP_TYPE"]))
            {//MANAGEMENT1_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["MANAGEMENT1"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["MANAGEMENT1_DESC"];

                MANAGEMENT1.EditValue = mPrevious_Code;
                MANAGEMENT1_DESC.EditValue = mPrevious_Name;
            }
            //2
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["MANAGEMENT2_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["MANAGEMENT2_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["MANAGEMENT2_LOOKUP_TYPE"]))
            {//MANAGEMENT2_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["MANAGEMENT2"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["MANAGEMENT2_DESC"];

                MANAGEMENT2.EditValue = mPrevious_Code;
                MANAGEMENT2_DESC.EditValue = mPrevious_Name;
            }
            //3
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER1_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER1_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER1_LOOKUP_TYPE"]))
            {//REFER1_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER1"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER1_DESC"];

                REFER1.EditValue = mPrevious_Code;
                REFER1_DESC.EditValue = mPrevious_Name;
            }
            //4
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER2_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER2_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER2_LOOKUP_TYPE"]))
            {//REFER2_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER2"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER2_DESC"];

                REFER2.EditValue = mPrevious_Code;
                REFER2_DESC.EditValue = mPrevious_Name;
            }
            //5
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER3_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER3_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER3_LOOKUP_TYPE"]))
            {//REFER3_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER3"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER3_DESC"];

                REFER3.EditValue = mPrevious_Code;
                REFER3_DESC.EditValue = mPrevious_Name;
            }
            //6
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER4_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER4_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER4_LOOKUP_TYPE"]))
            {//REFER4_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER4"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER4_DESC"];

                REFER4.EditValue = mPrevious_Code;
                REFER4_DESC.EditValue = mPrevious_Name;
            }
            //7
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER5_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER5_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER5_LOOKUP_TYPE"]))
            {//REFER5_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER5"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER5_DESC"];

                REFER5.EditValue = mPrevious_Code;
                REFER5_DESC.EditValue = mPrevious_Name;
            }
            //8
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER6_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER6_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER6_LOOKUP_TYPE"]))
            {//REFER6_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER6"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER6_DESC"];

                REFER6.EditValue = mPrevious_Code;
                REFER6_DESC.EditValue = mPrevious_Name;
            }
            //9
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER7_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER7_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER7_LOOKUP_TYPE"]))
            {//REFER7_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER7"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER7_DESC"];

                REFER7.EditValue = mPrevious_Code;
                REFER7_DESC.EditValue = mPrevious_Name;
            }
            //10
            mData_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER8_DATA_TYPE"]);
            mLookup_Type = iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRow["REFER8_LOOKUP_TYPE"]);
            if (mData_Type == "NUMBER".ToString())
            {
            }
            else if (mData_Type == "RATE".ToString())
            ...
            if (mPreviousRowPosition > -1
                && mLookup_Type != string.Empty
                && mLookup_Type == iString.ISNull(IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER8_LOOKUP_TYPE"]))
            {//REFER8_LOOKUP_TYPE
                mPrevious_Code = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER8"];
                mPrevious_Name = IDA_PE_CANCEL_SLIP_DTL.CurrentRows[mPreviousRowPosition]["REFER8_DESC"];
        ...
        private void FCMF0270_ACCOUNT_Load(object sender, EventArgs e)
        {             
            // 회계장부 정보 설정.
            GetAccountBook();
            IDA_PE_CANCEL_SLIP_DTL.FillSchema();
        }

        private void FCMF0270_ACCOUNT_Shown(object sender, EventArgs e)
        {
            igrSLIP_LINE.LastConfirmChanges();
            IDA_PE_CANCEL_SLIP_DTL.OraSelectData.AcceptChanges();
            IDA_PE_CANCEL_SLIP_DTL.Refillable = true;
             
            string vADD_FLAG = "N";
            IDA_PE_CANCEL_SLIP_DTL.SetSelectParamValue("P_SALE_HEADER_ID", V_PREPAID_EXPENSE_ID.EditValue);
            IDA_PE_CANCEL_SLIP_DTL.SetSelectParamValue("P_SLIP_LINE_TYPE", V_SLIP_LINE_TYPE.EditValue);
            IDA_PE_CANCEL_SLIP_DTL.Fill();
            if (IDA_PE_CANCEL_SLIP_DTL.CurrentRows.Count < 1)
            {
                IDA_PE_CANCEL_SLIP_DTL.AddUnder();
                vADD_FLAG = "Y";
                ...
                if (iString.ISNull(V_SLIP_LINE_TYPE.EditValue) == "VAT")
                {
                    ...
                    Set_Control_Item_Prompt(IDA_PE_CANCEL_SLIP_DTL.CurrentRow.RowState);
                }
            }
            if (iString.ISNull(V_SLIP_LINE_TYPE.EditValue) == "VAT")
            {
            ...
            Init_Set_Item_Prompt(IDA_PE_CANCEL_SLIP_DTL.CurrentRow);
            Init_Set_Item_Need(IDA_PE_CANCEL_SLIP_DTL.CurrentRow);
        ...
        {
            IDA_PE_CANCEL_SLIP_DTL.Delete();
            IDA_PE_CANCEL_SLIP_DTL.Update();            
        }
        ...
        private void idaSLIP_LINE_PreRowUpdate(ISPreRowUpdateEventArgs e)
        {
            ...
            {// 외화 계좌.
                if (mCURRENCY_CODE != iString.ISNull(e.Row["CURRENCY_CODE"]) && iString.ISDecimaltoZero(e.Row["EXCHANGE_RATE"]) == Convert.ToInt32(0))
        ...
        {
            if (IDA_PE_CANCEL_SLIP_DTL.UpdateChangedRowCount != 0 || IDA_PE_CANCEL_SLIP_DTL.ChangedRowCount == 0)
            {
