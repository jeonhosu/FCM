...
namespace FCMF0621
{
    public partial class FCMF0621 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0621(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void SearchDB()
        {
            ...
            IDA_BUDGET_ASSIGN_DEPT.Fill();
            IDA_BUDGET_ASSIGN_ACCOUNT.Fill();
        ...
        private void XLPrinting_1(string pOutChoice)
        {
            ...
            try
            {
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0621_001.xls";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
        ...
        private void FCMF0621_Load(object sender, EventArgs e)
        {

        }

        private void FCMF0621_Shown(object sender, EventArgs e)
        {
