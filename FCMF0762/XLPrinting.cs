...
namespace FCMF0762
{
    public class XLPrinting
    {
        ...
        private int mDefaultPageRow = 3;    // 페이지 증가후 PageCount 기본값
        ...
        public void HeaderWrite(object pLOCAL_DATE) 
        {
            ...
            try
            {
                ...
                mPrinting.XLSetCell(5, 33, vString);
        ...
        private int XlLine(System.Data.DataRow pRow, int pPrintingLine)
        {
            ...
            try
            {
                ...
                mPrinting.XLSetCell(vXLine, 52, vString);
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISDataAdapter pData)
        {
            ...
            mCopy_EndCol = 63;      // 복사될 Column 최대값  
            mCopy_EndRow = 40;      // 복사될 Row 최대값     

            mPrintingLastRow = 40;  //최종 인쇄 라인.       
            mCurrentRow = 11;       // 중간부분 뿌릴때 시작 부분
