...
namespace FCMF0215
{
    public partial class FCMF0215 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0215(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        public FCMF0215(Form pMainForm, ISAppInterface pAppInterface, object pGL_Date_FR, object pGL_Date_TO, object pSlip_Num)
        {
            InitializeComponent();
            this.MdiParent = pMainForm;
            isAppInterfaceAdv1.AppInterface = pAppInterface;
        ...
        public FCMF0215(Form pMainForm, ISAppInterface pAppInterface, object pGL_Date_FR, object pGL_Date_TO,
        ...
        private void GetAccountBook()
        {
            ...
            //적요 복사 여부//
            IDC_SLIP_REMARK_COPY_P.SetCommandParamValue("W_ASSEMBLY_ID", "FCMF0215");
        ...
        private void Get_Balance_Statement()
        {
            ...
            FCMF0215_SET vFCMF0215_SET = new FCMF0215_SET(isAppInterfaceAdv1.AppInterface, mSession_ID, mCurrency_Code, "R"
                                                        , ACCOUNT_CONTROL_ID.EditValue, ACCOUNT_CODE.EditValue, ACCOUNT_DESC.EditValue
                                                        , SLIP_DATE.EditValue);
            mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0215_SET, isAppInterfaceAdv1.AppInterface);
            vRESULT = vFCMF0215_SET.ShowDialog();
        ...
        private void XLPrinting_Main(string pOutput_Type)
        {
            ...
            //IDC_GET_REPORT_SET_P.SetCommandParamValue("P_ASSEMBLY_ID", "FCMF0215");
        ...
        private void XLPrinting(string pOutput_Type)
        {
                ...
                (itbSLIP.SelectedIndex == 1 && iString.ISNull(HEADER_ID.EditValue) != string.Empty))
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0215_001.xlsx";
                    //-------------------------------------------------------------------------------------
        ...
        private void XLPrinting_BSK(string pOutput_Type)
        {
                ...
                (itbSLIP.SelectedIndex == 1 && iString.ISNull(HEADER_ID.EditValue) != string.Empty))
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0215_011.xlsx";
                    //-------------------------------------------------------------------------------------
        ...
        private void FCMF0215_Load(object sender, EventArgs e)
        {
        ...
        private void FCMF0215_Shown(object sender, EventArgs e)
        {
        ...
        private void ibtSUB_FORM_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            {//받을어음
                ...
                FCMF0215_BILL vFCMF0215_BILL = new FCMF0215_BILL(isAppInterfaceAdv1.AppInterface, mDEPT_ID, mDEPT_NAME
                ...
                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0215_BILL, isAppInterfaceAdv1.AppInterface);
                dlgResult = vFCMF0215_BILL.ShowDialog();
                if (dlgResult == DialogResult.OK)
                {
                    //어음금액
                    GL_AMOUNT.EditValue = vFCMF0215_BILL.Get_BILL_AMOUNT;
                    //거래처.
                    Set_Management_Value("CUSTOMER", vFCMF0215_BILL.Get_VENDOR_CODE, vFCMF0215_BILL.Get_VENDOR_NAME);
                    //은행
                    Set_Management_Value("BANK", vFCMF0215_BILL.Get_BANK_CODE, vFCMF0215_BILL.Get_BANK_NAME);
                    //세금계산서발행일
                    Set_Management_Value("VAT_ISSUE_DATE", vFCMF0215_BILL.Get_VAT_ISSUE_DATE, null);
                    //발행일자
                    Set_Management_Value("ISSUE_DATE", vFCMF0215_BILL.Get_ISSUE_DATE, null);
                    //만기일자
                    Set_Management_Value("DUE_DATE", vFCMF0215_BILL.Get_DUE_DATE, null);
                    //만기일자
                    Set_Management_Value("TR_EXPIRATION_DATE", vFCMF0215_BILL.Get_DUE_DATE, null);  
                    //어음번호.
                    Set_Management_Value("RECEIVABLE_BILL", vFCMF0215_BILL.Get_BILL_NUM, String.Format("{0:###,###,###,###,###,###}", vFCMF0215_BILL.Get_BILL_AMOUNT));
                     
                    Init_DR_CR_Amount();    // 차대금액 생성 //
                    Init_Total_GL_Amount(); // 총합계 및 분개 차액 생성 //
                }
                vFCMF0215_BILL.Dispose();
            }
            ...
            {//지급어음
                ...
                if (dlgResult == DialogResult.OK)
                {
                    ...
                    Set_Management_Value("TR_EXPIRATION_DATE", vFCMF0215_BILL.Get_DUE_DATE, null);  
                    //어음번호.
                    Set_Management_Value("PAYABLE_BILL", vFCMF0215_BILL.Get_BILL_NUM, String.Format("{0:###,###,###,###,###,###}", vFCMF0215_BILL.Get_BILL_AMOUNT));
            ...
            {//외화획득용 구매(공급) 확인서
                ...
                FCMF0215_ITEM_DEAL vFCMF0215_ITEM_DEAL = new FCMF0215_ITEM_DEAL(isAppInterfaceAdv1.AppInterface, mISSUE_NUM, mCURRENCY_CODE
                                                                                , mVENDOR_CODE, mBANK_CODE, mISSUE_DATE);

                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0215_ITEM_DEAL, isAppInterfaceAdv1.AppInterface);
                dlgResult = vFCMF0215_ITEM_DEAL.ShowDialog();
                if (dlgResult == DialogResult.OK)
                {
                    //거래처.
                    MANAGEMENT1.EditValue = vFCMF0215_ITEM_DEAL.Get_VENDOR_CODE;
                    MANAGEMENT1_DESC.EditValue = vFCMF0215_ITEM_DEAL.Get_VENDOR_NAME;
                    //구매(공급)확인번호
                    MANAGEMENT2.EditValue = vFCMF0215_ITEM_DEAL.Get_ISSUE_NUM;
                    MANAGEMENT2_DESC.EditValue = DBNull.Value;

                    REFER4.EditValue = vFCMF0215_ITEM_DEAL.Get_BANK_CODE;
                    REFER4_DESC.EditValue = vFCMF0215_ITEM_DEAL.Get_BANK_NAME;

                    REFER5.EditValue = vFCMF0215_ITEM_DEAL.Get_ISSUE_DATE;                    
                }
                vFCMF0215_ITEM_DEAL.Dispose();
            }
            Application.UseWaitCursor = false;
            this.Cursor = System.Windows.Forms.Cursors.Default;
            Application.DoEvents();
        ...
        {
            IDC_GET_DOC_ATT_STATUS.SetCommandParamValue("P_SOURCE_CATEGORY", "SLIP_BUDGET");
