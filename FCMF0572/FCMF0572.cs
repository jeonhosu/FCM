...
namespace FCMF0572
{
    public partial class FCMF0572 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0572(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void FCMF0572_Load(object sender, EventArgs e)
        {
        ...
        private void XLPrinting1(string pOutput_Type)
        {
            ...
            if(vCountRowGrid > 0)
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0572_001.xls";
                    //-------------------------------------------------------------------------------------
