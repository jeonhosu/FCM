...
namespace FCMF0791
{
    public class XLPrinting_1
    {
        ...
        private int mIncrementCopyMAX = 37;  //복사되어질 행의 범위
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[0] = pGrid.GetColumnToIndex("DR_REMAIN"); //차변 : 잔액
            pGDColumn[1] = pGrid.GetColumnToIndex("DR_SUM");    //차변 : 합계
            pGDColumn[2] = pGrid.GetColumnToIndex("ITEM_NAME"); //계정과목
            pGDColumn[3] = pGrid.GetColumnToIndex("CR_SUM");    //대변 : 합계
            pGDColumn[4] = pGrid.GetColumnToIndex("CR_REMAIN"); //대변 : 잔액


            pXLColumn[0] = 2;  //차변 : 잔액
            pXLColumn[1] = 9;  //차변 : 합계
            pXLColumn[2] = 17; //계정과목
            pXLColumn[3] = 29; //대변 : 합계
            pXLColumn[4] = 37; //대변 : 잔액
        }
        ...
        private void XLHeader(InfoSummit.Win.ControlAdv.ISDataAdapter p_adapter_PRINT_TITLE)
        {
            ...
            try
            {
                ...
                if (vCountRow > 0)
                {
                    ...
                    //현재일(예>2011년 12월 31일 현재); 합잔에서 사용
        ...
        {
            int vPrintingLineEND = mCopyLineSUM - 1; //1~37: mCopyLineSUM=38에서 내용이 출력되는 행이 37 까지 이므로, 1을 빼면 된다
