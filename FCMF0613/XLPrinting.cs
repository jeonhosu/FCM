...
namespace FCMF0613
{
    public class XLPrinting
    {
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDCol)
        {
            ...
            // 그리드 or 아답터 위치.
            pGDCol[0] = pGrid.GetColumnToIndex("DEPT_NAME");
            pGDCol[1] = pGrid.GetColumnToIndex("DEPT_CODE");
            pGDCol[2] = pGrid.GetColumnToIndex("ACCOUNT_CODE");
            pGDCol[3] = pGrid.GetColumnToIndex("ACCOUNT_NAME");
            pGDCol[4] = pGrid.GetColumnToIndex("DEPT_DESC");
            pGDCol[5] = pGrid.GetColumnToIndex("ACCOUNT_DESC");
            pGDCol[6] = pGrid.GetColumnToIndex("BUDGET_YEAR_AMOUNT");
            pGDCol[7] = pGrid.GetColumnToIndex("SLIP_MONTH_1");
            pGDCol[8] = pGrid.GetColumnToIndex("SLIP_MONTH_2");
            pGDCol[9] = pGrid.GetColumnToIndex("SLIP_MONTH_3");
            pGDCol[10] = pGrid.GetColumnToIndex("SLIP_MONTH_4");
            pGDCol[11] = pGrid.GetColumnToIndex("SLIP_MONTH_5");
            pGDCol[12] = pGrid.GetColumnToIndex("SLIP_MONTH_6");
            pGDCol[13] = pGrid.GetColumnToIndex("SLIP_MONTH_7");
            pGDCol[14] = pGrid.GetColumnToIndex("SLIP_MONTH_8");
            pGDCol[15] = pGrid.GetColumnToIndex("SLIP_MONTH_9");
            pGDCol[16] = pGrid.GetColumnToIndex("SLIP_MONTH_10");
            pGDCol[17] = pGrid.GetColumnToIndex("SLIP_MONTH_11");
            pGDCol[18] = pGrid.GetColumnToIndex("SLIP_MONTH_12");
            pGDCol[19] = pGrid.GetColumnToIndex("SLIP_YEAR_AMOUNT");
            pGDCol[20] = pGrid.GetColumnToIndex("GAP_AMOUNT");
            pGDCol[21] = pGrid.GetColumnToIndex("USE_RATE");
        }
        ...
        private void SetArray2(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDCol)
        {
            ...
            pGDCol[4] = pGrid.GetColumnToIndex("BUDGET_YEAR_AMOUNT");
            pGDCol[5] = pGrid.GetColumnToIndex("SLIP_MONTH_1");
            pGDCol[6] = pGrid.GetColumnToIndex("SLIP_MONTH_2");
            pGDCol[7] = pGrid.GetColumnToIndex("SLIP_MONTH_3");
            pGDCol[8] = pGrid.GetColumnToIndex("SLIP_MONTH_4");
            pGDCol[9] = pGrid.GetColumnToIndex("SLIP_MONTH_5");
            pGDCol[10] = pGrid.GetColumnToIndex("SLIP_MONTH_6");
            pGDCol[11] = pGrid.GetColumnToIndex("SLIP_MONTH_7");
            pGDCol[12] = pGrid.GetColumnToIndex("SLIP_MONTH_8");
            pGDCol[13] = pGrid.GetColumnToIndex("SLIP_MONTH_9");
            pGDCol[14] = pGrid.GetColumnToIndex("SLIP_MONTH_10");
            pGDCol[15] = pGrid.GetColumnToIndex("SLIP_MONTH_11");
            pGDCol[16] = pGrid.GetColumnToIndex("SLIP_MONTH_12");
            pGDCol[17] = pGrid.GetColumnToIndex("SLIP_YEAR_AMOUNT");
            pGDCol[18] = pGrid.GetColumnToIndex("GAP_AMOUNT");
            pGDCol[19] = pGrid.GetColumnToIndex("USE_RATE");
        }
        ...
        public void HeaderWrite_1(object pBUDGET_YEAR)
        {// 헤더 인쇄.
            int vXLine = 0;
            int vXLColumn = 0;
        ...
        private int XLLine_1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, int pRow, int pXLine, int[] pGDCol, bool pPrint_Flag)
        {
        ...
        {// 실제 호출되는 부분.
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    vIDX_DEPT = pGrid.GetColumnToIndex("DEPT_CODE");
                    for(int vRow =0; vRow < pGrid.RowCount; vRow++)
                    {
                        ...
                        //부서코드 동일 여부 체크.
                        vPrint_Flag = true;
                        if (vDEPT_CODE == null || vDEPT_CODE == string.Empty || mIsNewPage == true)
                        {

                        }
                        else if (vDEPT_CODE != iString.ISNull(pGrid.GetCellValue(vRow, vIDX_DEPT)))
                        {
                        ...
                        {
                            vPrint_Flag = false;
                            mPrinting.XL_LineClearTOP(mCurrentRow, 1, 6);
                        }
                        vDEPT_CODE = iString.ISNull(pGrid.GetCellValue(vRow, vIDX_DEPT));

                        mCurrentRow = XLLine_1(pGrid, vRow, mCurrentRow, vGDCol, vPrint_Flag); // 현재 위치 인쇄 후 다음 인쇄행 리턴.
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    for (int vRow = 0; vRow < pGrid.RowCount; vRow++)
                    {
                        ...
                        {
                            vPrint_Flag = false;
                            mPrinting.XL_LineClearTOP(mCurrentRow, 1, 11);
                        }
