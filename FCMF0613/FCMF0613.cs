...
namespace FCMF0613
{
    public partial class FCMF0613 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0613(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void XLPrinting_1(string pOutChoice)
        {
            ...
            try
            {
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0613_001.xls";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
        ...
        private void XLPrinting_2(string pOutChoice)
        {
            ...
            try
            {
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0613_002.xls";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
                bool isOpen = xlPrinting.XLFileOpen();
        ...
        private void FCMF0613_Load(object sender, EventArgs e)
        {

        }

        private void FCMF0613_Shown(object sender, EventArgs e)
        {
