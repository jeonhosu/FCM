...
namespace FCMF0614
{
    public class XLPrinting
    {
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDCol)
        {
            ...
            pGDCol[6] = pGrid.GetColumnToIndex("THIS_BUDGET_AMOUNT");
            pGDCol[7] = pGrid.GetColumnToIndex("THIS_SLIP_AMOUNT");
            pGDCol[8] = pGrid.GetColumnToIndex("THIS_GAP_AMOUNT");
            pGDCol[9] = pGrid.GetColumnToIndex("THIS_USE_RATE");
            pGDCol[10] = pGrid.GetColumnToIndex("BUDGET_AMOUNT");
            pGDCol[11] = pGrid.GetColumnToIndex("SLIP_AMOUNT");
            pGDCol[12] = pGrid.GetColumnToIndex("GAP_AMOUNT");
            pGDCol[13] = pGrid.GetColumnToIndex("USE_RATE");
        }
        ...
        public void HeaderWrite_1(object pBUDGET_YEAR, object pBUDGET_MONTH)
        {// 헤더 인쇄.
            int vXLine = 0;
            int vXLColumn = 0;
