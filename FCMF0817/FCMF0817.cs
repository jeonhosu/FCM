...
namespace FCMF0817
{
    public partial class FCMF0817 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0817(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void SEARCH_DB()
        {
            ...
            IDA_TAX_BILL_AR_SUM.Fill();
            IDA_TAX_BILL_AR_ELEC.Fill();
            IDA_TAX_BILL_AR_ETC.Fill();
        }
        ...
        private void SHOW_TAX_INVOICE_DETAIL(object pTAX_CODE, object pVAT_GUBUN, object pCUSTOMER_ID)
        {
            ...
            TAX_BILL_DETAIL vTAX_BILL_DETAIL = new TAX_BILL_DETAIL(isAppInterfaceAdv1.AppInterface, pTAX_CODE, pVAT_GUBUN
                                                                    , W_ISSUE_DATE_FR.EditValue, W_ISSUE_DATE_TO.EditValue, pCUSTOMER_ID
                                                                    , V_BUSINESS_UNIT_TAX_YN.CheckBoxString);
            dlgVALUE = vTAX_BILL_DETAIL.ShowDialog();
            if (dlgVALUE == DialogResult.OK)
            {

            }
            vTAX_BILL_DETAIL.Dispose();
        ...
        private void ExportXL(ISDataAdapter pAdapter)
        {
            ...
            if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                bool vXLSaveOK = xlExport.XLExport(IDA_TAX_BILL_AR_SUM.OraSelectData, vsSaveExcelFileName, vsSheetName);
                if (vXLSaveOK == true)
                {
        ...
        {// pOutChoice : 출력구분.
            ...
            IDA_PRINT_TAX_BILL_AR_SUM.Fill();
            IDA_PRINT_TAX_BILL_AR_DETAIL.Fill();
            
            int vCountRow = IGR_PRINT_TAX_BILL_AR.RowCount;
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0817_001.xlsx";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
                ...
                if (isOpen == true)
                {
                    ...
                    // 실제 인쇄
                    vPageNumber = xlPrinting.LineWrite(IGR_PRINT_TAX_BILL_AR, IGR_PRINT_TAX_BILL_AR_DETAIL);
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    if (IDA_TAX_BILL_AR_SUM.IsFocused)
                    {
                        IDA_TAX_BILL_AR_SUM.Cancel();
                    } 
                }
        ...
        private void FCMF0817_Load(object sender, EventArgs e)
        {

        }

        private void FCMF0817_Shown(object sender, EventArgs e)
        {
            Default_Value();
        }
         
        private void IGR_TAX_BILL_AP_ELEC_CellDoubleClick(object pSender)
        {
            SHOW_TAX_INVOICE_DETAIL(IGR_TAX_BILL_AR_ELEC.GetCellValue("TAX_CODE")
                                    , IGR_TAX_BILL_AR_ELEC.GetCellValue("VAT_GUBUN")
                                    , IGR_TAX_BILL_AR_ELEC.GetCellValue("CUSTOMER_ID"));
        }

        private void IGR_TAX_BILL_AP_ETC_CellDoubleClick(object pSender)
        {
            SHOW_TAX_INVOICE_DETAIL(IGR_TAX_BILL_AR_ETC.GetCellValue("TAX_CODE")
                                    , IGR_TAX_BILL_AR_ETC.GetCellValue("VAT_GUBUN")
                                    , IGR_TAX_BILL_AR_ETC.GetCellValue("CUSTOMER_ID"));
        }
