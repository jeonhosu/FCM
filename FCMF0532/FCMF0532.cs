...
namespace FCMF0532
{
    public partial class FCMF0532 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0532(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        //        // open해야 할 파일명 지정.
        //        //-------------------------------------------------------------------------------------
        //        xlPrinting.OpenFileNameExcel = "FCMF0532_001.xlsx";
        //        //-------------------------------------------------------------------------------------
        //        // 파일 오픈.
        //        //-------------------------------------------------------------------------------------
        ...
        private void FCMF0532_Load(object sender, EventArgs e)
        {
            GB_REMAIN_STATUS.BringToFront();
        }

        private void FCMF0532_Shown(object sender, EventArgs e)
        {
            W_GL_DATE_FR.EditValue = iDate.ISGetDate(string.Format("{0}-01-01", iDate.ISYear(DateTime.Today))); 
            W_GL_DATE_TO.EditValue = DateTime.Today;
            W_BALANCE_DATE_FR.EditValue = W_GL_DATE_FR.EditValue;
            W_BALANCE_DATE_TO.EditValue = W_GL_DATE_TO.EditValue;

            V_RB_REMAIN_YES.CheckedState = ISUtil.Enum.CheckedState.Checked;
            IDA_AR_REMAIN_LIST.FillSchema();  
        }

        private void W_GL_DATE_FR_CurrentEditValidating(object pSender, ISEditAdvValidatingEventArgs e)
        {
            W_BALANCE_DATE_FR.EditValue = W_GL_DATE_FR.EditValue;
        }

        private void W_GL_DATE_TO_CurrentEditValidating(object pSender, ISEditAdvValidatingEventArgs e)
        {
            W_BALANCE_DATE_TO.EditValue = W_GL_DATE_TO.EditValue;
        }
        ...
        private void V_RB_CONFIRM_ALL_CheckChanged(object sender, EventArgs e)
        {
            ...
            W_REMAIN_AMT_FLAG.EditValue = iStatus.RadioCheckedString;
        }
