...
namespace FCMF0218
{
    public partial class FCMF0218 : Office2007Form
    {
        ...
        private void Confirm_Status(object pSELECT_CHECK_YN, object pHEADER_INTERFACE_ID, object pGL_DATE, object pCONFIRM_YN)
        {
            ...
            try
            {
                for (int i = 0; i < IDA_BALANCE_SLIP_INTERFACE.SelectRows.Count; i++)
                {
                    ...
                    for (int c = 0; c < igrSLIP_LINE.GridAdvExColElement.Count; c++)
                    {
                        ...
                        {
                            igrSLIP_LINE.SetCellValue(i + Row_Count, c, IDA_BALANCE_SLIP_INTERFACE.OraDataSet().Rows[i][c]);
                        }
                    } 
                    Set_Slip_Line_Seq();    //LINE SEQ 채번//
        ...
        {           
            ...
            CONFIRM_STATUS_0.EditValue = irbCONFIRM_NO.RadioCheckedString;
        ...
        {            
            ...
            Confirm_Status("Y", H_HEADER_INTERFACE_ID.EditValue, C_GL_DATE.EditValue, "Y");
        ...
        private void btnCONFIRM_RETURN_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            Confirm_Status("Y", H_HEADER_INTERFACE_ID.EditValue, C_GL_DATE.EditValue, "R");  //반려 
            Search_DB_DETAIL(H_HEADER_INTERFACE_ID.EditValue);
        }
        ...
        private void btnCONFIRM_CANCEL_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            Confirm_Status("Y", H_HEADER_INTERFACE_ID.EditValue, C_GL_DATE.EditValue, "N");  //승인취소 
        ...
        private void irbCONFIRM_Status_Click(object sender, EventArgs e)
        {
