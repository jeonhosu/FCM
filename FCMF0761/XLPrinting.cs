    ...
    public class XLPrinting
    {
      ...
      //  private string mSourceSheet3 = "SourceTab3";
        ...
        private void XlLineClear(int pPrintingLine, int vPageLine)
        {
            ...
            mPrinting.XL_LineDraw(vStartRow-1, vStartCol, vEndCol, 2);
        ...
        public void HeaderWrite(object pLOCAL_DATE) 
        {
            ...
            try
            {
                ...
                mPrinting.XLSetCell(5, 5, vString);

                //mPrinting.XLActiveSheet(mSourceSheet3);
                ////DAY
                //if (iDate.ISDate(pLOCAL_DATE) == true)
                //{
                //    vString = string.Format("{0:dd}", pLOCAL_DATE);
                //}
                //else
                //{
                //    vString = string.Empty;
                //}
                //mPrinting.XLSetCell(5, 44, vString);

                ////MONTH
                //if (iDate.ISDate(pLOCAL_DATE) == true)
                //{
                //    vString = string.Format("{0:MM}", pLOCAL_DATE);
                //}
                //else
                //{
                //    vString = string.Empty;
                //}
                //mPrinting.XLSetCell(5, 52, vString);

                ////YEAR
                //if (iDate.ISDate(pLOCAL_DATE) == true)
                //{
                //    vString = string.Format("{0:yyyy}", pLOCAL_DATE);
                //}
                //else
                //{
                //    vString = string.Empty;
                //}
                //mPrinting.XLSetCell(5, 60, vString);
            }
            catch (System.Exception ex)
            {
                mMessageError = ex.Message;
        ...
        private int XlLine(System.Data.DataRow pRow, int pPrintingLine)
        {
            ...
            try
            {
              //  mPrinting.XLSetCell(vXLine, 1, mCountLinePrinting);
                ...
                mPrinting.XLSetCell(vXLine, 42, vString);

                vObject = pRow["THIS_M_CR_AMOUNT"];
                if (iString.ISNull(vObject) != string.Empty)
                {
                    vString = string.Format("{0}", vObject);
                }
                ...
                mPrinting.XLSetCell(vXLine, 54, vString);

                vObject = pRow["ENDING_CR_BAL"];
                if (iString.ISNull(vObject) != string.Empty)
                {
                    vString = string.Format("{0}", vObject);
                }
                ...
                mPrinting.XLSetCell(vXLine, 60, vString);                                
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISDataAdapter pData)
        {
            ...
            mCopy_EndCol = 65;      // 복사될 Column 최대값  
            mCopy_EndRow = 39;      // 복사될 Row 최대값     

            mPrintingLastRow = 39;  //최종 인쇄 라인.       
            mCurrentRow = 8;       // 중간부분 뿌릴때 시작 부분
