...
namespace FCMF0628
{
    public partial class FCMF0628_DETAIL : Office2007Form
    {
        ...
        public FCMF0628_DETAIL()
        {
            InitializeComponent();
        }

        public FCMF0628_DETAIL(ISAppInterface pAppInterface, object pPERIOD_NAME, 
        ...
        public FCMF0628_DETAIL(ISAppInterface pAppInterface, object pPERIOD_NAME, object pSLIP_NUM, 
                            object pACCOUNT_DESC, object pACCOUNT_CODE, object pACCOUNT_CONTROL_ID,
                            object pBUDGET_DEPT_NAME, object pBUDGET_DEPT_ID)
        {
            InitializeComponent();
        ...
        //    {
        //        //-------------------------------------------------------------------------------------
        //        xlPrinting.OpenFileNameExcel = "FCMF0628_001.xls";
        //        //-------------------------------------------------------------------------------------
        ...
        private void FCMF0628_DETAIL_Shown(object sender, EventArgs e)
        {
            Application.UseWaitCursor = false;
            this.Cursor = Cursors.Default;
            Application.DoEvents();
