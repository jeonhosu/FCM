...
namespace FCMF0261
{
    public partial class FCMF0261 : Office2007Form
    {
        ...
        private void FCMF0261_Shown(object sender, EventArgs e)
        {
        ...
        {                          
            ...
            //전표 생성 화면//
            FCMF0261_SLIP vFCMF0261_SLIP = new FCMF0261_SLIP(this.MdiParent, isAppInterfaceAdv1.AppInterface, iConv.ISNull(W_SLIP_IF_FLAG.EditValue), mSession_ID, vSYS_DATE);
            DialogResult dlgResult = vFCMF0261_SLIP.ShowDialog(); 

            mSlip_Header_ID = vFCMF0261_SLIP.Get_Slip_Header_ID;
            mSlip_Num = vFCMF0261_SLIP.Get_Slip_Num;
            mSlip_Date = vFCMF0261_SLIP.Get_Slip_Date;

            vFCMF0261_SLIP.Close();
