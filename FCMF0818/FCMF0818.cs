...
namespace FCMF0818
{
    public partial class FCMF0818 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0818(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        {// pOutChoice : 출력구분.
            ...
            //인쇄용 그리드.
            IDA_PRINT_BILL_AP_SUM.Fill();
            IDA_PRINT_BILL_AP_DETAIL.Fill();

            int vCountRow = IGR_PRINT_BILL_AP_SUM.RowCount;
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0818_001.xlsx";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
                ...
                if (isOpen == true)
                {
                    ...
                    // 실제 인쇄
                    vPageNumber = xlPrinting.LineWrite_1(IGR_PRINT_BILL_AP_SUM, IGR_PRINT_BILL_AP_DETAIL);
        ...
        {// pOutChoice : 출력구분.
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0818_002.xlsx";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
                bool isOpen = xlPrinting.XLFileOpen();
        ...
        private void FCMF0818_Load(object sender, EventArgs e)
        {

        }

        private void FCMF0818_Shown(object sender, EventArgs e)
        {
            Default_Value();
        }
        ...
        private void IGR_BILL_AP_CellDoubleClick(object pSender)
        {
            SHOW_TAX_INVOICE_DETAIL(IGR_BILL_AP.GetCellValue("TAX_CODE")
                                    , IGR_BILL_AP.GetCellValue("VAT_GUBUN")
                                    , IGR_BILL_AP.GetCellValue("CUSTOMER_ID"));
        }
