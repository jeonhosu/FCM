...
namespace FCMF0266
{
    public partial class FCMF0266_SLIP : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0266_SLIP()
        {
            InitializeComponent();
        }

        public FCMF0266_SLIP(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        public FCMF0266_SLIP(Form pMainForm, ISAppInterface pAppInterface, string pStatus, Object pSESSION_ID, Object pSYS_DATE)
        {
            InitializeComponent();
            isAppInterfaceAdv1.AppInterface = pAppInterface;
        ...
        private void Search_DB()
        {
            ...
            {                 
                ...
                IDA_CARD_SLIP_GROUP_APPR.SetSelectParamValue("W_SLIP_FLAG", mSlip_Status);
            ...
            if (pShow_Flag == true)
            {
                try
                {
                    if (pSub_Panel == "AP_VAT")
                    {
                        ...
                        IDC_GET_CARD_VAT.SetCommandParamValue("W_CARD_APPROVAL_ID", IGR_CARD_SLIP_GROUP_APPR.GetCellValue("CARD_APPROVAL_ID"));
                        IDC_GET_CARD_VAT.SetCommandParamValue("W_VAT_TAX_TYPE", VAT_TAX_TYPE.EditValue);
                        IDC_GET_CARD_VAT.ExecuteNonQuery();
                        S_CARD_APPROVAL_ID.EditValue = IDC_GET_CARD_VAT.GetCommandParamValue("O_CARD_APPROVAL_ID");
        ...
        private void FCMF0266_SLIP_Load(object sender, EventArgs e)
        {           
            // 회계장부 정보 설정.
            GetAccountBook();
        ...
        private void FCMF0266_SLIP_Shown(object sender, EventArgs e)
        {
            BTN_LINE_INSERT.BringToFront();
            BTN_LINE_DELETE.BringToFront();
            BTN_SAVE.BringToFront(); 
        ...
        private void FCMF0266_SLIP_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void S_BTN_OK_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            IDC_SAVE_CARD_VAT.SetCommandParamValue("W_SYS_DATE", mSys_Date);
            IDC_SAVE_CARD_VAT.SetCommandParamValue("W_USER_ID", isAppInterfaceAdv1.USER_ID);
            IDC_SAVE_CARD_VAT.SetCommandParamValue("W_SESSION_ID", mSession_ID);
            IDC_SAVE_CARD_VAT.SetCommandParamValue("W_CONNECT_PERSON_ID", isAppInterfaceAdv1.PERSON_ID);
