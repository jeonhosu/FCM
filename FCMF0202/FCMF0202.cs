...
namespace FCMF0202
{
    public partial class FCMF0202 : Office2007Form
    {
        ...
        private void Get_Balance_Statement()
        {
            ...
            FCMF0202_SET vFCMF0202_SET = new FCMF0202_SET(isAppInterfaceAdv1.AppInterface, mSession_ID, mCurrency_Code, "R"
                                                        , ACCOUNT_CONTROL_ID.EditValue, ACCOUNT_CODE.EditValue, ACCOUNT_DESC.EditValue
                                                        , GL_DATE.EditValue);
            mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0202_SET, isAppInterfaceAdv1.AppInterface);
            ...
            if (pShow_Flag == true)
            {
                try
                {
                    ...
                    else if (pSub_Panel == "COPY_SLIP")
                    {
                        ...
                        GB_COPY_DOCUMENT.Height = 157;

                        GB_COPY_DOCUMENT.Border3DStyle = Border3DStyle.Bump;
                        GB_COPY_DOCUMENT.BorderStyle = BorderStyle.Fixed3D;

                        // 세부 조회창 마우스 드래그 
                        GB_COPY_DOCUMENT.Controls[0].MouseDown += GB_COPY_DOCUMENT_MouseDown;
                        GB_COPY_DOCUMENT.Controls[1].MouseDown += GB_COPY_DOCUMENT_MouseDown;
                        GB_COPY_DOCUMENT.Controls[0].MouseMove += GB_COPY_DOCUMENT_MouseMove;
                        GB_COPY_DOCUMENT.Controls[1].MouseMove += GB_COPY_DOCUMENT_MouseMove;
                        GB_COPY_DOCUMENT.Controls[0].MouseUp += GB_COPY_DOCUMENT_MouseUp;
                        GB_COPY_DOCUMENT.Controls[1].MouseUp += GB_COPY_DOCUMENT_MouseUp;
                        GB_COPY_DOCUMENT.BringToFront();
                    ...
                    else if (pSub_Panel == "SLIP_DRILL_DOWN")
                    {
                        ...
                        // 세부 조회창 마우스 드래그 
                        GB_SLIP_DRILL_DOWN.Controls[0].MouseDown += GB_SLIP_DRILL_DOWN_MouseDown;
                        GB_SLIP_DRILL_DOWN.Controls[1].MouseDown += GB_SLIP_DRILL_DOWN_MouseDown;
                        GB_SLIP_DRILL_DOWN.Controls[0].MouseMove += GB_SLIP_DRILL_DOWN_MouseMove;
                        GB_SLIP_DRILL_DOWN.Controls[1].MouseMove += GB_SLIP_DRILL_DOWN_MouseMove;
                        GB_SLIP_DRILL_DOWN.Controls[0].MouseUp += GB_SLIP_DRILL_DOWN_MouseUp;
                        GB_SLIP_DRILL_DOWN.Controls[1].MouseUp += GB_SLIP_DRILL_DOWN_MouseUp;

                        GB_SLIP_DRILL_DOWN.BringToFront();
        ...
        private void XLPrinting_Main(string pOutput_Type)
        {
            ...
            else
            {
                ...
                vSLIP_Date = igrSLIP_LIST.GetCellValue("SLIP_DATE");
                vSLIP_Num = igrSLIP_LIST.GetCellValue("SLIP_NUM"); 
            }
        ...
        private void ibtSUB_FORM_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            {//받을어음
                ...
                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0202_BILL, isAppInterfaceAdv1.AppInterface);
            ...
            {//외화획득용 구매(공급) 확인서
                ...
                mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0202_ITEM_DEAL, isAppInterfaceAdv1.AppInterface);
        ...
        private void BTN_COPY_SLIP_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            C_SLIP_TYPE.EditValue = SLIP_TYPE.EditValue;
            C_SLIP_TYPE_NAME.EditValue = SLIP_TYPE_NAME.EditValue;
        ...
        private void Ila_C_SLIP_TYPE_PrePopupShow(object pSender, ISLookupPopupShowEventArgs e)
        {
            ILD_SLIP_TYPE_SLIP_DOCU.SetLookupParamValue("P_ENABLED_FLAG", "Y");
        }
        ...
        private void GB_SLIP_DRILL_DOWN_MouseDown(object sender, MouseEventArgs e)
        {
            mIsClickInquiryDetail = true;
            mInquiryDetailPreX = e.X;
            mInquiryDetailPreY = e.Y;
        ...
        private void GB_SLIP_DRILL_DOWN_MouseMove(object sender, MouseEventArgs e)
        {
            if (mIsClickInquiryDetail && e.Button == MouseButtons.Left)
            {
                int gx = e.X - mInquiryDetailPreX;
                ...
                Point I = GB_SLIP_DRILL_DOWN.Location;
                I.Offset(gx, gy);
                GB_SLIP_DRILL_DOWN.Location = I;
            }
        }

        private void GB_SLIP_DRILL_DOWN_MouseUp(object sender, MouseEventArgs e)
        {
            mIsClickInquiryDetail = false;
        }
