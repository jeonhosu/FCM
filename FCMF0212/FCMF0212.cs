...
namespace FCMF0212
{
    public partial class FCMF0212 : Office2007Form
    {
        ...
        public FCMF0212(Form pMainForm, ISAppInterface pAppInterface)
        {
            ...
            HEADER_ID.EditValue = 500007181;
            SLIP_DATE.EditValue = "2022-04-30";
            SLIP_NUM.EditValue = "EXP220430001";
            mPrintOptionFlag = "Y";
        }
        ...
        private void XLPrinting_Main(string pOutput_Type)
        {
            ...
            IDC_GET_REPORT_SET.SetCommandParamValue("P_STD_DATE", SLIP_DATE.EditValue);
            IDC_GET_REPORT_SET.SetCommandParamValue("P_ASSEMBLY_ID", "FCMF0212");
        ...
        private void XLPrinting(string pReport_File_Name, string pOutput_Type, string pSaveFileName)
        {
            ...
            try
            {
                ...
                {
                    xlPrinting.OpenFileNameExcel = "FCMF0212_001.xlsx";
                }
                else
                {
        ...
        private void XLPrinting_SEK(string pReport_File_Name, string pOutput_Type, string pSaveFileName)
        {
            ...
            try
            {
                ...
                if (pReport_File_Name == string.Empty)
                {
                    xlPrinting.OpenFileNameExcel = "FCMF0212_021.xlsx";
                }
                else
                {
                    xlPrinting.OpenFileNameExcel = pReport_File_Name;
        ...
        private void XLPrinting_BHC(string pReport_File_Name, string pOutput_Type, string pSaveFileName)
        {
            ...
            try
            {
                ...
                if (pReport_File_Name == string.Empty)
                {
                    xlPrinting.OpenFileNameExcel = "FCMF0212_031.xlsx";
                }
                else
                {
                    xlPrinting.OpenFileNameExcel = pReport_File_Name;
                ...
                if (isOpen == true)
                {
                    ...
                    idaPRINT_SLIP_LINE.SetSelectParamValue("W_SLIP_HEADER_ID", HEADER_ID.EditValue);
                    idaPRINT_SLIP_LINE.Fill();
        ...
        private void XLPrinting_SIK(string pReport_File_Name, string pOutput_Type, string pSaveFileName, string pPrint_Appr_Step)
        {
            ...
            try
            {
                ...
                if (pReport_File_Name == string.Empty)
                { 
                    xlPrinting.OpenFileNameExcel = "FCMF0212_051.xlsx";
                }
                else
                {
                    xlPrinting.OpenFileNameExcel = pReport_File_Name;
                ...
                if (isOpen == true)
                {
                    ...
                    //인쇄 결재라인 설정//
                    //1.현업//
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP.SetCommandParamValue("P_DEPT_TYPE", "USER");
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP.ExecuteNonQuery();

                    //2.회계팀//
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM.SetCommandParamValue("P_DEPT_TYPE", "ACCOUNT");
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM.ExecuteNonQuery();
                    ...
                    if (pPrint_Appr_Step.Equals("Y"))
                    {
                        ...
                        xlPrinting.HeaderWrite_SIK(idaSLIP_HEADER, vSOB_DESC, IDC_GET_PRINT_APPROVAL_SLIP_TOP, IDC_GET_PRINT_APPROVAL_SLIP_BOTTOM, IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM, IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP);
                    }
                    else 
                        xlPrinting.HeaderWrite_SIK(idaSLIP_HEADER, vSOB_DESC, IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM, IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP);
        ...
        private void XLPrinting_DKT(string pReport_File_Name, string pOutput_Type, string pSaveFileName, string pPrint_Appr_Step)
        {
            ...
            try
            {
                ...
                if (pReport_File_Name == string.Empty)
                {
                    xlPrinting.OpenFileNameExcel = "FCMF0212_052.xlsx";
                }
                else
                {
                    xlPrinting.OpenFileNameExcel = pReport_File_Name;
                ...
                if (isOpen == true)
                {
                    ...
                    //인쇄 결재라인 설정//
                    //1.상단//
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP.SetCommandParamValue("P_DEPT_TYPE", "TOP");
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP.ExecuteNonQuery();

                    //2.하단//
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM.SetCommandParamValue("P_DEPT_TYPE", "BOTTOM");
                    IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM.ExecuteNonQuery();
                    ...
                    if (pPrint_Appr_Step.Equals("Y"))
                    {
                        ...
                        xlPrinting.HeaderWrite_DKT(idaSLIP_HEADER, vSOB_DESC, 
                                                    ...
                                                    IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP, IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM);
                    }
                    else
                        xlPrinting.HeaderWrite_DKT(idaSLIP_HEADER, vSOB_DESC, IDC_GET_SLIP_NUM_APPROVAL_LINE_TOP, IDC_GET_SLIP_NUM_APPROVAL_LINE_BOTTOM);
