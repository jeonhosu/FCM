...
namespace FCMF0823
{
    public partial class FCMF0823 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0823(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void XLPrinting_1(string pOutChoice, ISDataAdapter pAdpater)
        {// pOutChoice : 출력구분.
            string vMessageText = string.Empty;
            string vSaveFileName = string.Empty;

            int vCountRow = pAdpater.OraSelectData.Rows.Count;
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0823_001.xlsx";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
                ...
                {
                    //인쇄물 헤더 
                    IDC_PRINT_TITLE_P.ExecuteNonQuery();
                    object vPRINT_TITLE = IDC_PRINT_TITLE_P.GetCommandParamValue("O_PRINT_TITLE");
                    object vPRINT_SUB_TITLE = IDC_PRINT_TITLE_P.GetCommandParamValue("O_PRINT_SUB_TITLE");
                    
                    // 헤더 인쇄.
                    idaOPERATING_UNIT.Fill();
                    if (idaOPERATING_UNIT.SelectRows.Count > 0)
                    {
                        xlPrinting.HeaderWrite(idaOPERATING_UNIT, vPRINT_TITLE, vPRINT_SUB_TITLE);
                    }
                    // 실제 인쇄
                    vPageNumber = xlPrinting.LineWrite(pAdpater);
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    XLPrinting_1("PRINT", IDA_ZERO_RATE_DOCUMENT);
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Export)
                {
                    XLPrinting_1("FILE", IDA_ZERO_RATE_DOCUMENT);
                }
            }
        }
        ...
        private void FCMF0823_Load(object sender, EventArgs e)
        {
            IDA_ZERO_RATE_DOCUMENT.FillSchema();
        }

        private void FCMF0823_Shown(object sender, EventArgs e)
        {
            Set_Default_Value();
        }
