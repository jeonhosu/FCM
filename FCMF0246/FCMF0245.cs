...
namespace FCMF0245
{
    public partial class FCMF0245 : Office2007Form
    {
            ...
            if (vCountRowGrid > 0)
            {
                ...
                try
                {
                    ...
                    if (isOpen == true)
                    {
                        ...
                        {
                            ////[SAVE]
                            xlPrinting.Save("INVENTORY_"); //저장 파일명
                        }
        ...
        {
            IDA_APPROVAL_PERIOD.AddUnder();
            IGR_APPROVAL_PERIOD.SetCellValue("PERIOD_NAME", A_PERIOD_NAME.EditValue);
            IGR_APPROVAL_PERIOD.SetCellValue("DEPT_ID", A_DEPT_ID.EditValue);
