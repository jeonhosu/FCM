...
namespace FCMF0809
{
    public class XLPrinting
    {
        ...
        private int mCopy_EndCol = 51;
        private int mCopy_EndRow = 32;
        private int mPrintingLastRow = 31;  //최종 인쇄 라인.

        private int mCurrentRow = 12;       //현재 인쇄되는 row 위치.
        ...
        {// 헤더 인쇄.
            ...
            try
            {
                ...
                vXLine = 6;
                vXLColumn = 10;
                mPrinting.XLSetCell(vXLine, vXLColumn, string.Format("{0}, {1}",  pAdapter.CurrentRow["BUSINESS_TYPE"], pAdapter.CurrentRow["BUSINESS_ITEM"]));
                ...
                vXLine = 8;
                vXLColumn = 10;
                mPrinting.XLSetCell(vXLine, vXLColumn, pZERO_RATE_TYPE);
