...
namespace FCMF0506
{
    public class XLPrinting
    {
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn)
        {
            ...
            // 그리드 or 아답터 위치.
            pGDColumn[0] = pGrid.GetColumnToIndex("SUPP_CUST_CODE");
            pGDColumn[1] = pGrid.GetColumnToIndex("SUPP_CUST_NAME");
        ...
        public void HeaderWrite_1(object pCompanyName, object pPeriodName, object pACCOUNT_DESC)
        {// 헤더 인쇄.
            int vXLine = 0;
            ...
            try
            {
                ...
                // 기간
                vXLine = 3;
                mPrinting.XLSetCell(vXLine, 1, pPeriodName);

                //회사명
                vXLine = 5;
                mPrinting.XLSetCell(vXLine, 1, pCompanyName);

                //계정과목
                vXLine = 5; 
                mPrinting.XLSetCell(vXLine, 16, pACCOUNT_DESC);
        ...
        public void HeaderWrite_2(object pCompanyName, object pPeriodName, object pACCOUNT_DESC, object pCUSTOMER_DESC)
        {// 헤더 인쇄.
            int vXLine = 0; 
            ...
            try
            {
                ...
                //거래처
                vXLine = 5; 
                mPrinting.XLSetCell(vXLine, 16, pCUSTOMER_DESC);
