...
namespace FCMF0313
{
    public partial class FCMF0313 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0313(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void FCMF0313_Load(object sender, EventArgs e)
        {
            Set_DefaultValues();
            IDA_ASSET_IF_LIST.FillSchema();
        }

        private void FCMF0313_Shown(object sender, EventArgs e)
        {
