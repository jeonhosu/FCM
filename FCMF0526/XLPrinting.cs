...
namespace FCMF0526
{
    public class XLPrinting
    {
        ...
        private int mPrintingLastRow = 57;  //실제 데이터 인쇄 최종 라인.
        ...
        private int mMerger_Start = 0;
        private int mMerger_End = 0;
        ...
        public int ExcelWrite1(object pGL_DATE, InfoSummit.Win.ControlAdv.ISDataAdapter pBILL)
        {// 실제 호출되는 부분.
            ...
            {
                // 실제인쇄되는 행수.
                vTotalRow = pBILL.OraSelectData.Rows.Count;
                ...
                if (vTotalRow > 0)
                {
                    ...
                    foreach (System.Data.DataRow vRow in pBILL.OraSelectData.Rows)
                    {
                        vLIneRow++;
