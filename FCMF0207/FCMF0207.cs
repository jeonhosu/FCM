...
namespace FCMF0207
{
    public partial class FCMF0207 : Office2007Form
    {
        ...
        { 
            IDA_SLIP_BUDGET_EXCEL.SetSelectParamValue("P_SOB_ID", isAppInterfaceAdv1.SOB_ID);
            IDA_SLIP_BUDGET_EXCEL.Fill();
        ...
        private bool Set_Slip_Transfer()
        {
            ...
            vSTATUS = IDC_SET_SLIP_BUDGET_TRANSFER.GetCommandParamValue("O_STATUS").ToString();
            vMESSAGE = IDC_SET_SLIP_BUDGET_TRANSFER.GetCommandParamValue("O_MESSAGE");
            if (IDC_SET_SLIP_BUDGET_TRANSFER.ExcuteError == true || vSTATUS == "F")
            {
        ...
        private bool Cancel_Slip_Transfer()
        {
            ...
            vSTATUS = IDC_CANCEL_SLIP_BUDGET_TRANSFER.GetCommandParamValue("O_STATUS").ToString();
            vMESSAGE = IDC_CANCEL_SLIP_BUDGET_TRANSFER.GetCommandParamValue("O_MESSAGE");
            if (IDC_CANCEL_SLIP_BUDGET_TRANSFER.ExcuteError == true || vSTATUS == "F")
            {
                Application.UseWaitCursor = false;
                this.Cursor = Cursors.Default;
                Application.DoEvents();
        ...
        {
            IDA_SLIP_BUDGET_EXCEL.FillSchema(); 
        }
        ...
        private void BTN_EXPORT_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            FCMF0207_EXPORT vFCMF0207_EXPORT = new FCMF0207_EXPORT(this.MdiParent, isAppInterfaceAdv1.AppInterface);
            mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0207_EXPORT, isAppInterfaceAdv1.AppInterface);
            vdlgResult = vFCMF0207_EXPORT.ShowDialog();
            vFCMF0207_EXPORT.Dispose(); 
        }

        private void BTN_IMPORT_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            DialogResult vdlgResult;
            FCMF0207_IMPORT vFCMF0207_IMPORT = new FCMF0207_IMPORT(this.MdiParent, isAppInterfaceAdv1.AppInterface, mSESSION_ID);
            mEAPF1102.SetProperties(EAPF1102.INIT_TYPE.None, vFCMF0207_IMPORT, isAppInterfaceAdv1.AppInterface);
            vdlgResult = vFCMF0207_IMPORT.ShowDialog();
            vFCMF0207_IMPORT.Dispose();
