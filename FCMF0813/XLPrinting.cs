...
namespace FCMF0813
{
    public class XLPrinting
    {
        ...
        private int mCopy_2nd_EndRow = 129;     //2번째 페이지는 해당있을 경우만 인쇄.
        ...
        {// 헤더 인쇄.
            ...
            try
            {
                ...
                //일반과세자 부가가치세 FLAG//
                //예정
                if (iString.ISNull(pAdapter.CurrentRow["TITLE_FLAG_1"]) == "Y")
                {
                    vXLine = 2;
                    vXLColumn = 22;
                    mPrinting.XLSetCell(vXLine, vXLColumn, "V");
                }
                //확정
                if (iString.ISNull(pAdapter.CurrentRow["TITLE_FLAG_2"]) == "Y")
                {
                    vXLine = 2;
                    vXLColumn = 28;
                    mPrinting.XLSetCell(vXLine, vXLColumn, "V");
                ...
                //기한후과세표준
                if (iString.ISNull(pAdapter.CurrentRow["TITLE_FLAG_3"]) == "Y")
                {
                    vXLine = 3;
                    vXLColumn = 22;
                    mPrinting.XLSetCell(vXLine, vXLColumn, "V");
                ...
                //영세율 등 조기환급
                if (iString.ISNull(pAdapter.CurrentRow["TITLE_FLAG_4"]) == "Y")
                {
                    vXLine = 4;
                    vXLColumn = 22;
                    mPrinting.XLSetCell(vXLine, vXLColumn, "V");
                ...
                vXLine = 7;
                vXLColumn = 10;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["COMPANY_NAME"]);
                ...
                vXLine = 8;
                vXLColumn = 10;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["LEGAL_NUMBER"]);

                vXLine = 9;
                vXLColumn = 28;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["TEL_NUM_1"]);
                vXLColumn = 33;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["TEL_NUM_2"]);
                
                vXLine = 10;
                vXLColumn = 10;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["ADDR"]);
                ...
                vXLine = 42;
                vXLColumn = 17;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["DEAL_BANK_BRANCH_NAME"]);
                // 계좌.
                vXLColumn = 34;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["DEAL_BANK_ACCOUNT_NUM"]);

                // 신고자.
                vXLine = 49;
                vXLColumn = 30;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["CHARGE_PERSON_NAME"]);
        ...
        public void HeaderWrite_201401(InfoSummit.Win.ControlAdv.ISDataAdapter pAdapter, object pPERIOD, object pISSUE_PERIOD)
        {// 헤더 인쇄.
            int vXLine = 0;
            int vXLColumn = 0;
            ...
            try
            {
                ...
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["TEL_NUM_2"]);
                vXLColumn = 38;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["HP_NUM"]);
                ...
                vXLine = 54;
                vXLColumn = 26;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["TAX_OFFICE_DESC"]);
        ...
        public void HeaderWrite_013(InfoSummit.Win.ControlAdv.ISDataAdapter pAdapter, object pPERIOD, object pISSUE_PERIOD, object pWrite_Date)
        {// 헤더 인쇄.
            int vXLine = 0;
            int vXLColumn = 0;
            ...
            try
            {
                ...
                vXLine = 47;
                vXLColumn = 17;
                mPrinting.XLSetCell(vXLine, vXLColumn, string.Format("{0:yyyy-mm-dd}", pAdapter.CurrentRow["CLOSURE_DATE"]));
                // 폐업사유.
                vXLColumn = 30;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["CLOSURE_REASON"]);

                //영세율상호주의//
                //여부.
                vXLine = 48;
                vXLColumn = 12;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["ZR_RECIPROCITY_YN"]);
                // 적용구분.
                vXLColumn = 21;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["ZR_RECIPROCITY_TYPE"]);
                //업종
                vXLColumn = 30;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["ZR_BUSINESS_ITEM"]);
                //국가.
                vXLColumn = 40;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["ZR_COUNTRY_CODE"]);
                ...
                vXLine = 55;
                vXLColumn = 26;
                mPrinting.XLSetCell(vXLine, vXLColumn, string.Format("{0} 귀하", pAdapter.CurrentRow["TAX_OFFICE_DESC"]));
        ...
        private void XLLine_1_201401(InfoSummit.Win.ControlAdv.ISDataAdapter pData1)
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            int vXLine = 0; //엑셀에 내용이 표시되는 행 번호
            int vXLColumnIndex = 0;
            ...
            { // 원본을 복사해서 타겟 에 복사해 넣음.(
                ...
                vXLine = 24;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["P_EXPORT_IMPORT_POSTPONE_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(10-1)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["P_EXPORT_IMPORT_POSTPONE_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 37;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["PROXY_PAY_TAX_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(23)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["PROXY_PAY_TAX_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 38;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["SPECIAL_PAY_TAX_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(24)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["SPECIAL_PAY_TAX_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 41;
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["TOT_REAL_VAT_AMOUNT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
        ...
        private void XLLine_1_013(InfoSummit.Win.ControlAdv.ISDataAdapter pData1)
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            int vXLine = 0; //엑셀에 내용이 표시되는 행 번호
            int vXLColumnIndex = 0;
            ...
            { // 원본을 복사해서 타겟 에 복사해 넣음.(
                ...
                vXLine = 36;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["SMALL_PB_REDUC_VAT_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(21)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["SMALL_PB_REDUC_VAT_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 41;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["CARD_AGENT_PAY_TAX_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(25)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["CARD_AGENT_PAY_TAX_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
        ...
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            ...
            { // 원본을 복사해서 타겟 에 복사해 넣음.(
                ...
                vXLine = 92;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["R_ORIGIN_PLACE_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(55)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["R_ORIGIN_PLACE_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 100;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_TAX_RECEIVE_DELAY_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(61)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_TAX_RECEIVE_DELAY_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 105;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_TAX_INV_SUM_BAD_AMT_1"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(66)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_TAX_INV_SUM_BAD_VAT_1"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 106;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_REPORT_BAD_AMT_1"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(67)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_REPORT_BAD_VAT_1"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 107;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_REPORT_BAD_AMT_2"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(68)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_REPORT_BAD_VAT_2"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 108;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_REPORT_BAD_AMT_3"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(69)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_REPORT_BAD_VAT_3"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 109;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_REPORT_BAD_AMT_4"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(70)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_REPORT_BAD_VAT_4"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 113;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_REALTY_LEASE_UNREPORT_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(74)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_REALTY_LEASE_UNREPORT_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
        ...
        private void XLLine_2_201401(InfoSummit.Win.ControlAdv.ISDataAdapter pData1)
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            int vXLine = 63; //엑셀에 내용이 표시되는 행 번호
            int vXLColumnIndex = 0;
            ...
            { // 원본을 복사해서 타겟 에 복사해 넣음.(
                ...
                //(40)-신용카드매출전표등 수령명세서 제출분 일반매입 금액
                vXLine = 73;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["E_CREDIT_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                ...
                //(41)-신용카드매출전표등 수령명세서 제출분 고정자산매입 금액
                vXLine = 74;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["E_CREDIT_ASSET_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                ...
                //(47)-외국인 관광객에 대한 환급세액 금액
                vXLine = 80;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["E_FORE_TOUR_REFUND_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(47)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["E_FORE_TOUR_REFUND_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(75)-매입자 납부특례 거래계좌 미사용 금액
                vXLine = 114;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_MISS_DEAL_ACCOUNT_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(75)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_MISS_DEAL_ACCOUNT_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(76)-매입자 납부특례 거래계좌 지연입금 금액
                vXLine = 115;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["A_DELAY_PAYMENT_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //(76)-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["A_DELAY_PAYMENT_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 119;
                vXLColumnIndex = 9;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_TYPE"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //종목
                vXLColumnIndex = 17;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_ITEM"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드1
                vXLColumnIndex = 28;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_CODE_1"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드2
                vXLColumnIndex = 29;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_CODE_2"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드3
                vXLColumnIndex = 30;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_CODE_3"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드4
                vXLColumnIndex = 31;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_CODE_4"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드5
                vXLColumnIndex = 32;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_CODE_5"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드6
                vXLColumnIndex = 33;
                vObject = pData1.CurrentRow["TAX_FREE_1_BUSINESS_CODE_6"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //금액
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["TAX_FREE_1_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 120;
                vXLColumnIndex = 9;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_TYPE"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //종목
                vXLColumnIndex = 17;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_ITEM"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드1
                vXLColumnIndex = 28;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_CODE_1"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드2
                vXLColumnIndex = 29;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_CODE_2"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드3
                vXLColumnIndex = 30;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_CODE_3"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드4
                vXLColumnIndex = 31;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_CODE_4"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드5
                vXLColumnIndex = 32;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_CODE_5"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드6
                vXLColumnIndex = 33;
                vObject = pData1.CurrentRow["TAX_FREE_2_BUSINESS_CODE_6"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //금액
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["TAX_FREE_2_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 121;
                vXLColumnIndex = 9;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_TYPE"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //종목
                vXLColumnIndex = 17;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_ITEM"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드1
                vXLColumnIndex = 28;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_CODE_1"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드2
                vXLColumnIndex = 29;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_CODE_2"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드3
                vXLColumnIndex = 30;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_CODE_3"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드4
                vXLColumnIndex = 31;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_CODE_4"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드5
                vXLColumnIndex = 32;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_CODE_5"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드6
                vXLColumnIndex = 33;
                vObject = pData1.CurrentRow["TAX_FREE_9_BUSINESS_CODE_6"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //금액
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["TAX_FREE_9_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                vXLine = 122;
                vXLColumnIndex = 9;
                vObject = pData1.CurrentRow["TAX_FREE_TOT_BUSINESS_TYPE"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //종목
                vXLColumnIndex = 17;
                vObject = pData1.CurrentRow["TAX_FREE_TOT_BUSINESS_ITEM"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //코드1
                vXLColumnIndex = 28;
                vObject = pData1.CurrentRow["TAX_FREE_TOT_BUSINESS_CODE"];
                IsConvert = IsConvertString(vObject, out vConvertString);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0}", vConvertString);
                ...
                //금액
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["TAX_FREE_TOT_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
        ...
        private void XLLine_2_013(InfoSummit.Win.ControlAdv.ISDataAdapter pData1)
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            int vXLine = 65; //엑셀에 내용이 표시되는 행 번호
            int vXLColumnIndex = 0;
            ...
            { // 원본을 복사해서 타겟 에 복사해 넣음.(
                ...
                vXLine = 96;
                vXLColumnIndex = 21;
                vObject = pData1.CurrentRow["R_CARD_AGENT_PAY_TAX_AMT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
                ...
                //()-부가세
                vXLColumnIndex = 34;
                vObject = pData1.CurrentRow["R_CARD_AGENT_PAY_TAX_VAT"];
                IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                if (IsConvert == true)
                {
                    vConvertString = string.Format("{0:###,###,###,###,###,###,###,###}", vConvertDecimal);
        ...
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            ...
            string vTAX_STANDARD_CODE = string.Empty;
            int vGrid_Col_IDX = 0;
            int vXLine = 49; //엑셀에 내용이 표시되는 행 번호
            int vXLColumnIndex = 0;
            ...
            { //
                ...
                {
                    vGrid_Col_IDX = pGrid.GetColumnToIndex("TAX_STANDARD_CODE");
                    vObject = pGrid.GetCellValue(nRow, vGrid_Col_IDX);
                    vTAX_STANDARD_CODE = iString.ISNull(vObject);
                    if (vTAX_STANDARD_CODE == "-")
                    {
                        vXLine = 53;
                    }
                    else
        ...
        public void XLLine_3_201401(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid)
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            ...
            { //
                ...
                for (int nRow = 0; nRow < pGrid.RowCount; nRow++)
                {
                    ...
                    // 생산요수.
                    vXLColumnIndex = 12;
                    vGrid_Col_IDX = pGrid.GetColumnToIndex("PRODUCTION_ELEMENT");
                    vObject = pGrid.GetCellValue(nRow, vGrid_Col_IDX);
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    {
        ...
        public void XLLine_3_013(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid)
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.

            string vTAX_STANDARD_CODE = string.Empty;
            int vGrid_Col_IDX = 0;
            int vXLine = 51; //엑셀에 내용이 표시되는 행 번호
            int vXLColumnIndex = 0;
        ...
        public int LineWrite_201401(InfoSummit.Win.ControlAdv.ISDataAdapter pData1, InfoSummit.Win.ControlAdv.ISDataAdapter pData2)
        {// 실제 호출되는 부분.
            string vMessage = string.Empty;
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    XLLine_1_201401(pData1); // 현재 위치 인쇄 후 다음 인쇄행 리턴.
        ...
        public int LineWrite_013(InfoSummit.Win.ControlAdv.ISDataAdapter pData1, InfoSummit.Win.ControlAdv.ISDataAdapter pData2)
        {// 실제 호출되는 부분.
            string vMessage = string.Empty;
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    XLLine_1_013(pData1); // 현재 위치 인쇄 후 다음 인쇄행 리턴.
