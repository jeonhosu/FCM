...
namespace FCMF0517
{
    public partial class FCMF0517 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0517(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void Search_DB()
        {
            ...
            {//지급어음
                idaBILL_EXPIRY_PERIOD.SetSelectParamValue("W_BILL_CLASS", "1");
                idaBILL_EXPIRY_PERIOD.Fill();

                igrPAYABLE_BILL.Focus();
            }
            else if (itbBILL.SelectedTab.TabIndex == 2)
            {//받을어음.
                idaBILL_EXPIRY_PERIOD.SetSelectParamValue("W_BILL_CLASS", "2");
                idaBILL_EXPIRY_PERIOD.Fill();
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    if (idaBILL_EXPIRY_PERIOD.IsFocused)
                    {
                        idaBILL_EXPIRY_PERIOD.AddOver();
                    }
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.AddUnder)
                {
                    if (idaBILL_EXPIRY_PERIOD.IsFocused)
                    {
                        idaBILL_EXPIRY_PERIOD.AddUnder();
                    }
                }
        ...
        {// pOutChoice : 출력구분.
            ...
            if (pOutChoice == "FILE")
            {
                ...
                if (itbBILL.SelectedTab.TabIndex == 1)
                {
                    vSaveFileName = String.Format("전자어음 만기 도래일 내역(지급어음명세서)");
                }
                else if (itbBILL.SelectedTab.TabIndex == 2)
                {
                    vSaveFileName = String.Format("전자어음 만기 도래일 내역(받을어음명세서)");
                }
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0517_001.xls";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
