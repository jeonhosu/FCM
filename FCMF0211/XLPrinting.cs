...
namespace FCMF0211
{
    public class XLPrinting
    {
        ...
        public void HeaderWrite_SEK(InfoSummit.Win.ControlAdv.ISDataAdapter pAdapter, object pSOB_DESC, object pLOCAL_DATE)
        {
            object vObject = null;
            string vString = string.Empty;

            mSourceSheet1 = "SourceTab1";
            mSourceSheet2 = "SourceTab1";
            mTargetSheet = "Destination";
            ...
            try
            {
                ...
                mPrinting.XLSetCell(6, 5, vString); 
                ...
                mPrinting.XLSetCell(6, 17, vString); 
                ...
                mPrinting.XLSetCell(5, 17, vString); 
                                    ...
                                    , InfoSummit.Win.ControlAdv.ISDataCommand pSlip_Approval_Line_User)
        {
            ...
            try
            {
                ...
                if (iString.ISNull(pPrint_Appr_Person_BOTTOM.GetCommandParamValue("O_APPR_N")).Equals("Y"))
                {
                    ...
                    //회계승인
                    if (iString.ISNull(pPrint_Appr_Person_BOTTOM.GetCommandParamValue("O_APPR_C")).Equals("Y"))
                    {
                        vObject = pPrint_Appr_Person_BOTTOM.GetCommandParamValue("O_PRINT_NAME_C");
                        if (iString.ISNull(vObject) != string.Empty)
                        {
                            vString = string.Format("{0}", vObject);
                        }
        ...
        public void HeaderWrite_DKT(InfoSummit.Win.ControlAdv.ISDataAdapter pAdapter, object pSOB_DESC
                                    , InfoSummit.Win.ControlAdv.ISDataCommand pSlip_Approval_Line_TOP, InfoSummit.Win.ControlAdv.ISDataCommand pSlip_Approval_Line_BOTTOM)
        {
            int vLine = 1;
            object vObject = null;
            string vString = string.Empty;
        ...
        private int XlLine_SEK(System.Data.DataRow pRow, int pPrintingLine)
        {
            int vXLine = pPrintingLine; //엑셀에 내용이 표시되는 행 번호
            ...
            try
            {
                ...
                mPrinting.XLSetCell(vXLine + 1, 3, vString);
        ...
        private void SumWrite_SEK(int pPrintingLine)
        {
            ...
            //[합계]
            vLINE = vLINE - 2;
            mPrinting.XLSetCell(vLINE, 1, "합계");
            string vAmount = string.Empty;
             
            vAmount = string.Format("{0:#,###,###,###,###,###,###,###,###,##0}", mDR_AMOUNT);
            mPrinting.XLSetCell(vLINE, 12, vAmount);
 
            vAmount = string.Format("{0:#,###,###,###,###,###,###,###,###,##0}", mCR_AMOUNT);
            mPrinting.XLSetCell(vLINE, 18, vAmount);
        ...
        public int LineWrite_SEK(InfoSummit.Win.ControlAdv.ISDataAdapter pData)
        {
            ...
            mDefaultEndPageRow = 3;
            mDefaultPageRow = 10;    // 페이지 증가후 PageCount 기본값.
